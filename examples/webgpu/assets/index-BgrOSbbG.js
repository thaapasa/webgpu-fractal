var oe=Object.defineProperty;var re=(i,e,t)=>e in i?oe(i,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):i[e]=t;var n=(i,e,t)=>re(i,typeof e!="symbol"?e+"":e,t);(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))s(a);new MutationObserver(a=>{for(const r of a)if(r.type==="childList")for(const h of r.addedNodes)h.tagName==="LINK"&&h.rel==="modulepreload"&&s(h)}).observe(document,{childList:!0,subtree:!0});function t(a){const r={};return a.integrity&&(r.integrity=a.integrity),a.referrerPolicy&&(r.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?r.credentials="include":a.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function s(a){if(a.ep)return;a.ep=!0;const r=t(a);fetch(a.href,r)}})();class L{constructor(e){n(this,"device");n(this,"context");n(this,"canvas");n(this,"format");n(this,"animationFrameId",null);n(this,"renderCallback",null);n(this,"hdrEnabled",!1);n(this,"_displaySupportsHDR",!1);n(this,"hdrMediaQuery",null);n(this,"onHdrChangeCallback",null);this.canvas=e,this._displaySupportsHDR=this.detectHDRDisplay(),this.setupHdrMediaQueryListener()}get displaySupportsHDR(){return this._displaySupportsHDR}static async create(e){const t=new L(e);return await t.initialize(),t}static isSupported(){return"gpu"in navigator}async initialize(){if(!navigator.gpu)throw new Error("WebGPU is not supported in this browser");console.log("WebGPU HDR capability check:"),console.log("  - Display supports HDR:",this.displaySupportsHDR),console.log("  - dynamic-range: high:",window.matchMedia?.("(dynamic-range: high)").matches),console.log("  - color-gamut: p3:",window.matchMedia?.("(color-gamut: p3)").matches);const e=await navigator.gpu.requestAdapter({powerPreference:"high-performance"});if(!e)throw new Error("Failed to get WebGPU adapter");if("info"in e){const t=e.info;console.log("  - Adapter:",t?.vendor,t?.architecture)}if(this.device=await e.requestDevice(),this.context=this.canvas.getContext("webgpu"),!this.context)throw new Error("Failed to get WebGPU context");this.configureContext(),console.log("WebGPU initialized successfully"),this.hdrEnabled&&console.log("HDR mode enabled with rgba16float + extended tone mapping")}configureContext(){const e=navigator.gpu.getPreferredCanvasFormat();if(this.displaySupportsHDR)try{this.format="rgba16float",this.context.configure({device:this.device,format:this.format,alphaMode:"opaque",toneMapping:{mode:"extended"}}),this.hdrEnabled=!0,console.log("  - Configured with rgba16float + extended tone mapping (HDR)")}catch(t){console.log("  - HDR configuration failed, falling back to SDR:",t),this.format=e,this.context.configure({device:this.device,format:this.format,alphaMode:"opaque"}),this.hdrEnabled=!1}else this.format=e,this.context.configure({device:this.device,format:this.format,alphaMode:"opaque"}),this.hdrEnabled=!1,console.log("  - Configured with",this.format,"(SDR)")}resize(e,t){const s=window.devicePixelRatio||1;this.canvas.width=e*s,this.canvas.height=t*s,this.canvas.style.width=`${e}px`,this.canvas.style.height=`${t}px`}getCurrentTexture(){return this.context.getCurrentTexture()}start(e){if(this.animationFrameId!==null)return;this.renderCallback=e;const t=()=>{this.renderCallback&&this.renderCallback(),this.animationFrameId=requestAnimationFrame(t)};this.animationFrameId=requestAnimationFrame(t)}stop(){this.animationFrameId!==null&&(cancelAnimationFrame(this.animationFrameId),this.animationFrameId=null),this.renderCallback=null}detectHDRDisplay(){return!!window.matchMedia?.("(dynamic-range: high)").matches}setupHdrMediaQueryListener(){if(!window.matchMedia)return;this.hdrMediaQuery=window.matchMedia("(dynamic-range: high)");const e=()=>{const t=this.detectHDRDisplay();t!==this._displaySupportsHDR&&(console.log(`HDR display support changed: ${this._displaySupportsHDR} -> ${t}`),this._displaySupportsHDR=t,this.context&&this.device&&this.configureContext(),this.onHdrChangeCallback?.())};this.hdrMediaQuery.addEventListener?.("change",e)}setOnHdrChange(e){this.onHdrChangeCallback=e}destroy(){this.stop(),this.onHdrChangeCallback=null,this.device?.destroy()}}const le=.6;function J(i){return 1+(i-1)*le}const w=class w{constructor(e,t,s,a={}){n(this,"canvas");n(this,"viewState");n(this,"onChange");n(this,"callbacks");n(this,"isDragging",!1);n(this,"lastX",0);n(this,"lastY",0);n(this,"lastTouchDistance",0);n(this,"juliaPickerMode",!1);n(this,"isPickingJulia",!1);n(this,"juliaPickViewState",null);n(this,"keyboardZoomDirection",null);n(this,"keyboardZoomStartTime",0);n(this,"keyboardZoomAnimationId",null);n(this,"locationKeyHeld",null);n(this,"locationLongPressTimeout",null);n(this,"fractalKeyHeld",null);n(this,"fractalLongPressTimeout",null);this.canvas=e,this.viewState=t,this.onChange=s,this.callbacks=a,this.setupEventListeners()}setCallbacks(e){this.callbacks={...this.callbacks,...e}}setJuliaPickerMode(e){this.juliaPickerMode=e,this.canvas.style.cursor=e?"crosshair":"grab"}isJuliaPickerModeActive(){return this.juliaPickerMode}setupEventListeners(){this.canvas.addEventListener("mousedown",this.handleMouseDown.bind(this)),this.canvas.addEventListener("mousemove",this.handleMouseMove.bind(this)),this.canvas.addEventListener("mouseup",this.handleMouseUp.bind(this)),this.canvas.addEventListener("mouseleave",this.handleMouseUp.bind(this)),this.canvas.addEventListener("wheel",this.handleWheel.bind(this),{passive:!1}),this.canvas.addEventListener("dblclick",this.handleDoubleClick.bind(this)),this.canvas.addEventListener("touchstart",this.handleTouchStart.bind(this),{passive:!1}),this.canvas.addEventListener("touchmove",this.handleTouchMove.bind(this),{passive:!1}),this.canvas.addEventListener("touchend",this.handleTouchEnd.bind(this)),this.canvas.addEventListener("touchcancel",this.handleTouchEnd.bind(this)),window.addEventListener("keydown",this.handleKeyDown.bind(this)),window.addEventListener("keyup",this.handleKeyUp.bind(this))}getCanvasRect(){return this.canvas.getBoundingClientRect()}getScreenCoords(e,t){const s=this.getCanvasRect();return[e-s.left,t-s.top]}getCanvasSize(){const e=this.getCanvasRect();return[e.width,e.height]}toFractalCoordsWithView(e,t,s,a,r){const h=s/a,d=(e/s-.5)*h,f=t/a-.5,l=r.centerX+d/r.zoom,p=r.centerY-f/r.zoom;return[l,p]}notifyChange(){this.onChange(this.viewState)}handleMouseDown(e){if(e.button!==0)return;const[t,s]=this.getScreenCoords(e.clientX,e.clientY);if(this.juliaPickerMode&&this.callbacks.onJuliaPick){const[a,r]=this.getCanvasSize();this.juliaPickViewState={centerX:this.viewState.centerX,centerY:this.viewState.centerY,zoom:this.viewState.zoom};const[h,d]=this.toFractalCoordsWithView(t,s,a,r,this.juliaPickViewState);this.isPickingJulia=!0,this.lastX=t,this.lastY=s,this.callbacks.onJuliaPick(h,d);return}this.isDragging=!0,this.lastX=t,this.lastY=s,this.canvas.style.cursor="grabbing"}handleMouseMove(e){const[t,s]=this.getScreenCoords(e.clientX,e.clientY);if(this.isPickingJulia&&this.callbacks.onJuliaPick&&this.juliaPickViewState){const[f,l]=this.getCanvasSize(),[p,y]=this.toFractalCoordsWithView(t,s,f,l,this.juliaPickViewState);this.callbacks.onJuliaPick(p,y),this.lastX=t,this.lastY=s;return}if(!this.isDragging)return;const a=t-this.lastX,r=s-this.lastY,[h,d]=this.getCanvasSize();this.viewState.pan(a,r,h,d),this.notifyChange(),this.lastX=t,this.lastY=s}handleMouseUp(){if(this.isPickingJulia){this.isPickingJulia=!1,this.juliaPickViewState=null,this.callbacks.onJuliaPickEnd?.();return}this.isDragging&&(this.isDragging=!1,this.canvas.style.cursor="grab")}handleWheel(e){e.preventDefault(),this.callbacks.onUserInput?.();const[t,s]=this.getScreenCoords(e.clientX,e.clientY),a=e.deltaY>0?.9:1.1,r=J(a),[h,d]=this.getCanvasSize();this.viewState.zoomAt(t,s,r,h,d),this.notifyChange()}handleDoubleClick(e){const[t,s]=this.getScreenCoords(e.clientX,e.clientY),[a,r]=this.getCanvasSize();this.viewState.zoomToPoint(t,s,J(2),a,r),this.notifyChange()}getTouchDistance(e){if(e.length<2)return 0;const t=e[0].clientX-e[1].clientX,s=e[0].clientY-e[1].clientY;return Math.sqrt(t*t+s*s)}getTouchCenter(e){if(e.length===0)return[0,0];if(e.length===1)return this.getScreenCoords(e[0].clientX,e[0].clientY);const t=(e[0].clientX+e[1].clientX)/2,s=(e[0].clientY+e[1].clientY)/2;return this.getScreenCoords(t,s)}handleTouchStart(e){if(this.callbacks.onUserInput?.(),e.touches.length===1){this.isDragging=!0;const[t,s]=this.getScreenCoords(e.touches[0].clientX,e.touches[0].clientY);this.lastX=t,this.lastY=s}else e.touches.length===2&&(this.isDragging=!1,this.lastTouchDistance=this.getTouchDistance(e.touches))}handleTouchMove(e){if(e.preventDefault(),e.touches.length===1&&this.isDragging){const[t,s]=this.getScreenCoords(e.touches[0].clientX,e.touches[0].clientY),a=t-this.lastX,r=s-this.lastY,[h,d]=this.getCanvasSize();this.viewState.pan(a,r,h,d),this.notifyChange(),this.lastX=t,this.lastY=s}else if(e.touches.length===2){const t=this.getTouchDistance(e.touches),s=this.getTouchCenter(e.touches);if(this.lastTouchDistance>0){const a=t/this.lastTouchDistance,r=J(a),[h,d]=this.getCanvasSize();this.viewState.zoomAt(s[0],s[1],r,h,d),this.notifyChange()}this.lastTouchDistance=t}}handleTouchEnd(){this.isDragging=!1,this.lastTouchDistance=0}handleKeyDown(e){if(!(e.target instanceof HTMLInputElement||e.target instanceof HTMLTextAreaElement))switch(e.key){case"+":case"=":e.preventDefault(),this.callbacks.onIterationAdjust?.(1);break;case"-":case"_":e.preventDefault(),this.callbacks.onIterationAdjust?.(-1);break;case"0":e.preventDefault(),this.callbacks.onIterationReset?.();break;case"c":e.preventDefault(),this.callbacks.onCosinePaletteCycle?.(1);break;case"C":e.preventDefault(),this.callbacks.onCosinePaletteCycle?.(-1);break;case"g":e.preventDefault(),this.callbacks.onGradientPaletteCycle?.(1);break;case"G":e.preventDefault(),this.callbacks.onGradientPaletteCycle?.(-1);break;case"[":case",":e.preventDefault(),this.callbacks.onColorOffsetAdjust?.(-.05);break;case"]":case".":e.preventDefault(),this.callbacks.onColorOffsetAdjust?.(.05);break;case"{":case"<":e.preventDefault(),this.callbacks.onColorOffsetAdjust?.(-.15);break;case"}":case">":e.preventDefault(),this.callbacks.onColorOffsetAdjust?.(.15);break;case"r":case"R":e.preventDefault(),this.callbacks.onColorOffsetReset?.();break;case"b":e.preventDefault(),this.callbacks.onBrightnessAdjust?.(1);break;case"B":e.preventDefault(),this.callbacks.onBrightnessAdjust?.(-1);break;case"d":e.preventDefault(),this.callbacks.onBrightnessReset?.();break;case"f":e.preventDefault(),!e.repeat&&this.fractalKeyHeld!=="f"&&(this.fractalKeyHeld="f",this.fractalLongPressTimeout=setTimeout(()=>{this.fractalKeyHeld==="f"&&(this.callbacks.onFractalCycleAnimate?.(1),this.fractalKeyHeld=null)},w.LONG_PRESS_THRESHOLD));break;case"F":e.preventDefault(),!e.repeat&&this.fractalKeyHeld!=="F"&&(this.fractalKeyHeld="F",this.fractalLongPressTimeout=setTimeout(()=>{this.fractalKeyHeld==="F"&&(this.callbacks.onFractalCycleAnimate?.(-1),this.fractalKeyHeld=null)},w.LONG_PRESS_THRESHOLD));break;case"j":case"J":e.preventDefault(),this.callbacks.onToggleJuliaMode?.();break;case"s":case"S":e.preventDefault(),this.callbacks.onShare?.();break;case"1":case"2":case"3":case"4":case"5":case"6":case"7":case"8":case"9":e.preventDefault(),!e.repeat&&this.locationKeyHeld!==e.key&&(this.locationKeyHeld=e.key,this.locationLongPressTimeout=setTimeout(()=>{this.locationKeyHeld===e.key&&(this.callbacks.onLocationAnimate?.(e.key),this.locationKeyHeld=null)},w.LONG_PRESS_THRESHOLD));break;case"h":case"H":e.preventDefault(),this.callbacks.onToggleHelp?.();break;case" ":e.preventDefault(),this.callbacks.onToggleScreenshotMode?.();break;case"t":case"T":e.preventDefault(),this.callbacks.onToggleTouristMode?.();break;case"z":e.preventDefault(),e.repeat||this.startKeyboardZoom(1);break;case"Z":e.preventDefault(),e.repeat||this.startKeyboardZoom(-1);break}}handleKeyUp(e){if((e.key==="z"||e.key==="Z")&&this.stopKeyboardZoom(),e.key>="1"&&e.key<="9"&&this.locationKeyHeld===e.key&&(this.locationLongPressTimeout!==null&&(clearTimeout(this.locationLongPressTimeout),this.locationLongPressTimeout=null),this.callbacks.onLocationSelect?.(e.key),this.locationKeyHeld=null),(e.key==="f"||e.key==="F")&&this.fractalKeyHeld===e.key){this.fractalLongPressTimeout!==null&&(clearTimeout(this.fractalLongPressTimeout),this.fractalLongPressTimeout=null);const t=e.key==="f"?1:-1;this.callbacks.onFractalCycle?.(t),this.fractalKeyHeld=null}}startKeyboardZoom(e){this.keyboardZoomAnimationId!==null&&this.stopKeyboardZoom(),this.keyboardZoomDirection=e,this.keyboardZoomStartTime=performance.now(),this.keyboardZoomAnimationId=requestAnimationFrame(this.keyboardZoomLoop.bind(this))}stopKeyboardZoom(){this.keyboardZoomAnimationId!==null&&(cancelAnimationFrame(this.keyboardZoomAnimationId),this.keyboardZoomAnimationId=null),this.keyboardZoomDirection=null}keyboardZoomLoop(e){if(this.keyboardZoomDirection===null)return;const t=e-this.keyboardZoomStartTime;this.keyboardZoomStartTime=e;const a=this.keyboardZoomDirection*.7*(t/1e3),r=Math.exp(a),[h,d]=this.getCanvasSize();this.viewState.zoomAt(h/2,d/2,r,h,d),this.notifyChange(),this.keyboardZoomAnimationId=requestAnimationFrame(this.keyboardZoomLoop.bind(this))}destroy(){}};n(w,"LONG_PRESS_THRESHOLD",400);let N=w;var o=(i=>(i[i.Mandelbrot=0]="Mandelbrot",i[i.MandelbrotJulia=1]="MandelbrotJulia",i[i.BurningShip=2]="BurningShip",i[i.BurningShipJulia=3]="BurningShipJulia",i[i.Tricorn=4]="Tricorn",i[i.TricornJulia=5]="TricornJulia",i[i.Celtic=6]="Celtic",i[i.CelticJulia=7]="CelticJulia",i[i.Buffalo=8]="Buffalo",i[i.BuffaloJulia=9]="BuffaloJulia",i[i.Phoenix=10]="Phoenix",i[i.PhoenixJulia=11]="PhoenixJulia",i[i.Multibrot3=12]="Multibrot3",i[i.Multibrot3Julia=13]="Multibrot3Julia",i[i.Multibrot4=14]="Multibrot4",i[i.Multibrot4Julia=15]="Multibrot4Julia",i[i.Funky=16]="Funky",i[i.FunkyJulia=17]="FunkyJulia",i[i.Perpendicular=18]="Perpendicular",i[i.PerpendicularJulia=19]="PerpendicularJulia",i))(o||{});const ce={0:"Mandelbrot",1:"Mandelbrot Julia",2:"Burning Ship",3:"Burning Ship Julia",4:"Tricorn",5:"Tricorn Julia",6:"Celtic",7:"Celtic Julia",8:"Buffalo",9:"Buffalo Julia",10:"Phoenix",11:"Phoenix Julia",12:"Multibrot (z³)",13:"Multibrot³ Julia",14:"Multibrot (z⁴)",15:"Multibrot⁴ Julia",16:"Funky",17:"Funky Julia",18:"Perpendicular",19:"Perpendicular Julia"},S=10;function M(i){return(i&1)===1}function k(i){return i&-2}function he(i){return i|1}const m={TYPE:"t",CENTER_X:"x",CENTER_Y:"y",ZOOM:"z",PALETTE:"p",PALETTE_TYPE:"pt",COSINE_PALETTE:"cp",GRADIENT_PALETTE:"gp",COLOR_OFFSET:"o",JULIA_REAL:"jr",JULIA_IMAG:"ji",ITERATIONS:"i",AA:"aa"};function C(i,e=15){return i===0?"0":Math.abs(i)<1e-10||Math.abs(i)>1e10?i.toExponential(e):parseFloat(i.toPrecision(e)).toString()}function T(i){if(i===null||i==="")return null;const e=parseFloat(i);return isNaN(e)?null:e}function te(i){const e=new URLSearchParams;return e.set(m.TYPE,i.fractalType.toString()),e.set(m.CENTER_X,C(i.centerX)),e.set(m.CENTER_Y,C(i.centerY)),e.set(m.ZOOM,C(i.zoom)),e.set(m.PALETTE_TYPE,i.paletteType==="cosine"?"c":"g"),e.set(m.COSINE_PALETTE,i.cosinePaletteIndex.toString()),e.set(m.GRADIENT_PALETTE,i.gradientPaletteIndex.toString()),Math.abs(i.colorOffset)>.001&&e.set(m.COLOR_OFFSET,C(i.colorOffset,4)),M(i.fractalType)&&(e.set(m.JULIA_REAL,C(i.juliaC[0])),e.set(m.JULIA_IMAG,C(i.juliaC[1]))),i.maxIterationsOverride!==null&&e.set(m.ITERATIONS,i.maxIterationsOverride.toString()),i.aaEnabled&&e.set(m.AA,"1"),e.toString()}function de(i){const e=new URLSearchParams(i.replace(/^#/,"")),t={},s=T(e.get(m.TYPE));s!==null&&s>=0&&s<=19&&(t.fractalType=s);const a=T(e.get(m.CENTER_X));a!==null&&(t.centerX=a);const r=T(e.get(m.CENTER_Y));r!==null&&(t.centerY=r);const h=T(e.get(m.ZOOM));h!==null&&h>0&&(t.zoom=h);const d=e.get(m.PALETTE_TYPE);(d==="c"||d==="g")&&(t.paletteType=d==="c"?"cosine":"gradient");const f=T(e.get(m.COSINE_PALETTE));f!==null&&f>=0&&(t.cosinePaletteIndex=Math.floor(f));const l=T(e.get(m.GRADIENT_PALETTE));l!==null&&l>=0&&(t.gradientPaletteIndex=Math.floor(l));const p=T(e.get(m.PALETTE));p!==null&&p>=0&&p<=11&&(t.paletteIndex=Math.floor(p));const y=T(e.get(m.COLOR_OFFSET));y!==null&&(t.colorOffset=y);const b=T(e.get(m.JULIA_REAL)),u=T(e.get(m.JULIA_IMAG));b!==null&&u!==null&&(t.juliaC=[b,u]);const g=T(e.get(m.ITERATIONS));return g!==null&&g>0&&(t.maxIterationsOverride=Math.floor(g)),e.get(m.AA)==="1"&&(t.aaEnabled=!0),t}function ue(i){const e=te(i),t=new URL(window.location.href);return t.hash=e,t.toString()}function fe(i){const e=te(i);window.history.replaceState(null,"","#"+e)}function pe(){return de(window.location.hash)}async function me(i){const e=ue(i);try{return await navigator.clipboard.writeText(e),!0}catch{const t=document.createElement("textarea");t.value=e,t.style.position="fixed",t.style.left="-9999px",document.body.appendChild(t),t.select();try{return document.execCommand("copy"),!0}catch{return!1}finally{document.body.removeChild(t)}}}function c(i,e,t,s,a,r,h,d={}){return{name:i,description:e,key:t,state:{fractalType:s,centerX:a,centerY:r,zoom:h,paletteType:d.paletteType??"cosine",cosinePaletteIndex:d.cosinePaletteIndex??1,gradientPaletteIndex:d.gradientPaletteIndex??0,colorOffset:d.colorOffset??0,juliaC:d.juliaC??[-.7,.27015],maxIterationsOverride:d.maxIterationsOverride??null,aaEnabled:!1}}}const ge=[c("Mandelbrot","The famous Mandelbrot set","1",o.Mandelbrot,-.5,0,.4),c("Seahorse Valley","The iconic seahorse-shaped spirals","2",o.Mandelbrot,-.7581249305506096,.11244273987387937,36.41989684959737,{cosinePaletteIndex:5,colorOffset:.05}),c("Elephant Valley","Elephant trunk-like spirals on the positive real side","3",o.Mandelbrot,.2746341335933571,.0066936145282295205,212.15493874953236,{cosinePaletteIndex:3,colorOffset:-.1}),c("Double Spiral Valley","Beautiful double spirals deep in the set","4",o.Mandelbrot,-.743733589978665,.130905227502858,350,{cosinePaletteIndex:5,colorOffset:.15}),c("Spiral Galaxy","Galactic spiral arms emerging from chaos","5",o.Mandelbrot,-.7615484049386866,-.08478444765887823,1506.4927460380957,{cosinePaletteIndex:4,colorOffset:.05}),c("Douady Rabbit","The famous rabbit-eared Julia set","6",o.MandelbrotJulia,0,0,.6,{cosinePaletteIndex:4,colorOffset:.2,juliaC:[-.123,.745]}),c("Dragon Julia","Fierce dragon-like Julia set","7",o.MandelbrotJulia,0,0,.45,{cosinePaletteIndex:3,colorOffset:-.5,juliaC:[-.8,.156]}),c("Spiral Julia","Delicate spiral arms from the main cardioid edge","8",o.MandelbrotJulia,0,0,.5,{cosinePaletteIndex:8,colorOffset:.65,juliaC:[-.75,.11]}),c("Dendrite Julia","Tree-like branching structure on the real axis","9",o.MandelbrotJulia,0,0,.41791083585808675,{cosinePaletteIndex:5,colorOffset:.1,juliaC:[.285,.01]})],ye=[c("Main Ship","The iconic burning ship silhouette","1",o.BurningShip,-.6819541375872399,.5906040268456356,.4,{cosinePaletteIndex:4,colorOffset:.3}),c("The Armada","Mini ships along the antenna","2",o.BurningShip,-1.80173025652805,.0153452534367207,9,{cosinePaletteIndex:4,colorOffset:.2}),c("Bow Detail","Intricate patterns at the ship's bow","3",o.BurningShip,-1.7500929615866607,.0368035491770765,10,{cosinePaletteIndex:10,colorOffset:.1}),c("Bacteria Worm","Worm-like structures with mosaic patterns","4",o.BurningShipJulia,0,0,.3,{cosinePaletteIndex:10,colorOffset:-.55,juliaC:[.5179709888623353,.8057669844188748]}),c("Wispy Coils","Wispy coils near the bulbous extrusion from the ship","5",o.BurningShipJulia,0,0,.4,{cosinePaletteIndex:4,colorOffset:.35,juliaC:[.2525994076160102,.0006358222328731386]}),c("Space Brain","Brain-like structures from the bottom of the ship","6",o.BurningShipJulia,0,0,.7,{cosinePaletteIndex:5,colorOffset:.3,juliaC:[-1.059944784917394,-.033218825489255054]}),c("Spiral Patterns","Spiral patterns near the bulbous extrusion","7",o.BurningShipJulia,0,0,.41,{cosinePaletteIndex:11,colorOffset:.55,juliaC:[.28292507376881926,-.007597008191683113]}),c("Detailed Patterns","Beautiful detailed patterns near the bottom of the ship","8",o.BurningShipJulia,0,0,.5,{cosinePaletteIndex:2,colorOffset:.6,juliaC:[-.3967192382583807,-.09102348993288789]})],be=[c("Tricorn","The main tricorn shape with its distinctive three-cornered symmetry","1",o.Tricorn,-.1343398614022916,-.07051105375213641,.24,{cosinePaletteIndex:11,colorOffset:-.45}),c("Skewed Mandelbrot","Skewed Mandelbrot from one of the main bulbs","2",o.Tricorn,-1.0683098234816064,.13055543771605108,722.5553792774821,{cosinePaletteIndex:5,colorOffset:.1}),c("Lightning Bolts","Lightning bolt-like patterns near the main cardioid edge","3",o.TricornJulia,0,0,.5,{cosinePaletteIndex:5,colorOffset:.2,juliaC:[-.7092474160797806,-.113024316756254]}),c("Water Lily Leaf","Leaf-like structures from the center of the edge of the main cardioid","4",o.TricornJulia,0,0,.43,{colorOffset:-.7,juliaC:[-.1254330794660274,.2407433439223678]}),c("Lightning Brain","Brain-like structures","5",o.TricornJulia,0,0,3.15,{cosinePaletteIndex:5,juliaC:[.8748878776979363,-1.515483485507111]}),c("Spiral Mosaic","Mosaic patterns from the base of one of the main bulbs","6",o.TricornJulia,0,0,.5,{cosinePaletteIndex:11,colorOffset:.55,juliaC:[-.5647012802389192,-.06508603367125808]}),c("Electric Tendrils","Electric tendril patterns with bright highlights","7",o.TricornJulia,0,0,.5,{cosinePaletteIndex:4,colorOffset:.05,juliaC:[-.511125124692869,.0500484416152959]})],ve=[c("Celtic Knot","The main Celtic fractal shape","1",o.Celtic,-.5,0,.25,{cosinePaletteIndex:10,colorOffset:.05}),c("Celtic Detail","Intricate knotwork patterns","2",o.Celtic,-.7803221774980102,.1635662989215261,120,{cosinePaletteIndex:10,colorOffset:.25,maxIterationsOverride:1e4}),c("Leafy Spirals","Symmetric shapes from the tip of the celtic shape","3",o.CelticJulia,0,0,.55,{cosinePaletteIndex:7,colorOffset:.1,juliaC:[.25345198072532704,.0001580704105713714]}),c("Tendrils","Tendrils emerging from fog","4",o.CelticJulia,-.1649932591722856,-.033582161161888655,.28,{cosinePaletteIndex:5,juliaC:[-.4530201342281876,-.8993288590604025]}),c("Electric Buzz","Electric patterns with uniform patterned regions","5",o.CelticJulia,.2,-.3,.55,{colorOffset:.2,juliaC:[-.6378073937333775,1.2082886796996293]}),c("Intricate Patterns","Knotwork patterns with intricate details","6",o.CelticJulia,0,0,.52,{cosinePaletteIndex:10,colorOffset:.3,juliaC:[-.7610237673309276,.12050023730653406]}),c("Petri Dish","Bacteria-like patterns that spread outwards","7",o.CelticJulia,0,0,.55,{cosinePaletteIndex:10,colorOffset:.45,juliaC:[-1.056655765809614,-.16855216053399263]})],xe=[c("Buffalo Overview","The distinctive Buffalo fractal shape","1",o.Buffalo,-.7,.6,.4,{cosinePaletteIndex:2,colorOffset:.45}),c("Overgrown Cities","Tree or cathedral-like structures emerging from real axis","2",o.Buffalo,-1.75,.13,2.4,{colorOffset:0}),c("Industrial Snowflake","Snowflake-like patterns with industrial structures woven in","3",o.BuffaloJulia,.45,0,.85,{cosinePaletteIndex:4,colorOffset:-.1,juliaC:[-1.62727125821226,.00873720402364775]}),c("Plasma Bursts","Plasma-like bursts of color","4",o.BuffaloJulia,0,0,.5,{cosinePaletteIndex:8,colorOffset:-.75,juliaC:[.2745030250648227,.1797320656871218]}),c("Intricate Patterns","Intricate patterns near the bottom of the main shape","5",o.BuffaloJulia,0,0,.5,{cosinePaletteIndex:4,colorOffset:.25,juliaC:[-.5828307625231954,-.3049842077590671]}),c("Seed Pods","Spirals bursting with seeds","6",o.BuffaloJulia,0,0,.6,{cosinePaletteIndex:3,colorOffset:-.75,juliaC:[.3056228373702423,-.007698961937716242]})],Te=[c("Phoenix Overview","The Phoenix parameter space","1",o.Phoenix,-.15,-.7,.25,{cosinePaletteIndex:5,colorOffset:-.65}),c("Classic Phoenix Julia","The iconic feathery Phoenix fractal","2",o.PhoenixJulia,0,0,.5,{cosinePaletteIndex:2,colorOffset:.45,juliaC:[-.5,.5667],maxIterationsOverride:1152}),c("Phoenix Feathers","Detailed feather-like structures","3",o.PhoenixJulia,.38,.07,3.4,{cosinePaletteIndex:5,juliaC:[-.5,.5667]}),c("Golden Weaves","Bright golden patterns with intricate weaves","4",o.PhoenixJulia,0,.08,.4,{cosinePaletteIndex:2,colorOffset:.35,juliaC:[.656142759731905,.0353380147311402]}),c("Fiery Phoenix","Fiery wings spreading outwards","5",o.PhoenixJulia,0,-.03,.6,{cosinePaletteIndex:4,colorOffset:-.7,juliaC:[-.272349453272398,.4059142585519806]})],Ie=[c("Multibrot³ Overview","The three-fold symmetric z³ Multibrot","1",o.Multibrot3,0,0,.35,{cosinePaletteIndex:5,colorOffset:.35}),c("The Bulb","A bulbous extrusion from the main shape","2",o.Multibrot3,.5852686308492299,.27,6,{colorOffset:.1}),c("Three-fold Spirals","Bright pearly spirals with three-fold symmetry","3",o.Multibrot3Julia,0,0,.4,{cosinePaletteIndex:10,colorOffset:.15,juliaC:[.5448826747676219,.26362559338015445]}),c("Multibrot³ Julia","A Julia set with three-fold symmetry","4",o.Multibrot3Julia,0,0,.434,{cosinePaletteIndex:5,colorOffset:.1,juliaC:[-.45963436785036077,.03389484474578987]}),c("Double Elephant Valley","Two elephants in each group","5",o.Multibrot3,.42814685603247177,.012748071569601296,77,{cosinePaletteIndex:3,colorOffset:0}),c("Wonky Spiral","Wonky spiral Julia structure from inside the main set","6",o.Multibrot3Julia,.3695408370900379,.3371264555793177,2.274691481464049,{cosinePaletteIndex:0,colorOffset:0,juliaC:[.5277614770068884,.15853942850341446],maxIterationsOverride:2124}),c("Spiral Galaxies","The wonky spiral Julia structure viewed as galaxies","7",o.Multibrot3Julia,0,0,.4,{paletteType:"gradient",juliaC:[.5277614770068884,.15853942850341446],maxIterationsOverride:1152})],Pe=[c("Multibrot⁴ Overview","The four-fold symmetric z⁴ Multibrot","1",o.Multibrot4,0,0,.4,{cosinePaletteIndex:5,colorOffset:0}),c("Atomic Spirals","Structures resembling atomic orbitals with spiral patterns","2",o.Multibrot4Julia,0,-0,.35,{cosinePaletteIndex:5,colorOffset:.4,juliaC:[-.7878865573262246,.02073442187254452]}),c("Triple Elephant Valley","Now there's three elephants in each group!","3",o.Multibrot4,-.2726362830546699,.44295218397589975,42,{cosinePaletteIndex:3}),c("Starscape","Spiraling galaxies surrounding a black hole","4",o.Multibrot4Julia,0,0,.5,{paletteType:"gradient",juliaC:[.634977850702787,.194816172925824],maxIterationsOverride:1152}),c("Static Burst","Burst of electricity","5",o.Multibrot4Julia,0,0,.4,{colorOffset:-.75,juliaC:[-.6179887054490777,.487166930716755]})],ze=[c("Funky Overview","The wonderfully weird Funky fractal","1",o.Funky,-.5,0,.35,{cosinePaletteIndex:4,colorOffset:.25}),c("Tulip Bulb","Extrusions resembling tulips near the top of the main shape","2",o.Funky,.303,.534,6.3,{cosinePaletteIndex:10}),c("Battleship","Spaceship-like structure with double turrets all around","3",o.FunkyJulia,0,0,.45,{cosinePaletteIndex:4,colorOffset:-.7,juliaC:[-1.02568231965141,.128286053018475]}),c("Frog Crab","Crablike structure with brain-like spiral patterns within it","4",o.FunkyJulia,0,0,.37,{colorOffset:.1,juliaC:[.30191025227457674,.5253550579235958]}),c("Spiral Details","Beautiful spiral details without too much clutter","5",o.FunkyJulia,-.2,0,.4,{cosinePaletteIndex:5,colorOffset:.6,juliaC:[-.06404194046216194,.662960137583706]}),c("Migrating Birds","Bird-like shapes flying in formation","6",o.FunkyJulia,.34,0,.35,{cosinePaletteIndex:5,colorOffset:.4,juliaC:[.5804003550040334,-.9094296635818582]}),c("Glittering Coral","Brightly gleaming coral-like structures","7",o.FunkyJulia,0,0,.5,{cosinePaletteIndex:11,colorOffset:-.4,juliaC:[-.45427582797825017,-.06920415224913506]})],Me=[c("Perpendicular Overview","The Perpendicular Mandelbrot variant","1",o.Perpendicular,-.5,0,.32,{cosinePaletteIndex:2,colorOffset:0}),c("Seed Pod","A pod-like structure near the head of the main shape","2",o.Perpendicular,-.7734996631118647,.12393043736115505,250,{cosinePaletteIndex:5}),c("Bird of Prey","Waveform bird flying out to get you","3",o.PerpendicularJulia,0,0,.35,{cosinePaletteIndex:4,colorOffset:.15,juliaC:[-1.2870593206662457,.022288689289989876]}),c("Old Dragon","Bird-like shape with leathery frayed wings","4",o.PerpendicularJulia,0,0,.3913248754208607,{cosinePaletteIndex:5,colorOffset:.45,juliaC:[-1.0197782349577895,-.13982096184940793]}),c("Peacock Eyes","Glowing eyes of a brightly coloured peacock","5",o.PerpendicularJulia,0,-.8821542839734092,2.8,{cosinePaletteIndex:11,juliaC:[.25987719401314263,-.17615047146201984]}),c("Mask of the Ancients","A detailed mask with intricate patterns","6",o.PerpendicularJulia,0,0,.42,{cosinePaletteIndex:2,colorOffset:-.1,juliaC:[.3021983882651174,.4025604479726435]})],ie=new Map([[o.Mandelbrot,ge],[o.BurningShip,ye],[o.Tricorn,be],[o.Celtic,ve],[o.Buffalo,xe],[o.Phoenix,Te],[o.Multibrot3,Ie],[o.Multibrot4,Pe],[o.Funky,ze],[o.Perpendicular,Me]]);function R(i,e){const t=k(e),s=ie.get(t);if(s)return s.find(a=>a.key===i)}function Ce(i){const e=k(i);return ie.get(e)??[]}const D=[{name:"Rainbow",isMonotonic:!1,params:{type:"cosine",a:[.5,.5,.5],b:[.5,.5,.5],c:[1,1,1],d:[0,.33,.67]}},{name:"Fire",isMonotonic:!1,params:{type:"cosine",a:[.5,.5,.5],b:[.5,.5,.5],c:[1,1,.5],d:[0,.1,.2]}},{name:"Ice",isMonotonic:!1,params:{type:"cosine",a:[.5,.5,.5],b:[.5,.5,.5],c:[1,.7,.4],d:[0,.15,.2]}},{name:"Sunset",isMonotonic:!1,params:{type:"cosine",a:[.5,.3,.2],b:[.5,.4,.3],c:[1,1,.5],d:[0,.1,.2]}},{name:"Electric",isMonotonic:!1,params:{type:"cosine",a:[.5,.5,.5],b:[.6,.6,.6],c:[1,1,1],d:[.3,.2,.2]}},{name:"Neon",isMonotonic:!1,params:{type:"cosine",a:[.5,.5,.5],b:[.5,.5,.5],c:[1,1,1],d:[0,.1,.2]}},{name:"Emerald",isMonotonic:!1,params:{type:"cosine",a:[.2,.5,.3],b:[.3,.5,.3],c:[1,1,1],d:[0,.25,.5]}},{name:"Candy",isMonotonic:!1,params:{type:"cosine",a:[.8,.5,.5],b:[.2,.4,.4],c:[1,1,2],d:[0,.25,.25]}},{name:"Plasma",isMonotonic:!1,params:{type:"cosine",a:[.5,.5,.5],b:[.5,.5,.5],c:[2,1,0],d:[.5,.2,.25]}},{name:"Peacock",isMonotonic:!1,params:{type:"cosine",a:[.3,.5,.5],b:[.4,.4,.3],c:[1,1,1],d:[0,.1,.35]}},{name:"Autumn",isMonotonic:!1,params:{type:"cosine",a:[.6,.4,.2],b:[.4,.3,.2],c:[1,1,1],d:[0,.05,.1]}},{name:"Aurora",isMonotonic:!1,params:{type:"cosine",a:[.3,.5,.5],b:[.5,.5,.5],c:[1,1,.5],d:[.8,.9,.3]}}],I=D.length,j=[{name:"Blue",isMonotonic:!0,params:{type:"gradient",c1:[.02,.01,.08],c2:[.05,.15,.25],c3:[.1,.4,.5],c4:[.3,.6,.8],c5:[.7,.9,1]},hdrParams:{type:"gradient",c1:[.2,.4,1],c2:[.3,.6,1],c3:[.4,.8,1],c4:[.6,.9,1],c5:[.85,1,1]}},{name:"Gold",isMonotonic:!0,params:{type:"gradient",c1:[.04,.02,.01],c2:[.2,.08,.02],c3:[.5,.25,.05],c4:[.85,.6,.2],c5:[1,.95,.7]},hdrParams:{type:"gradient",c1:[1,.5,.1],c2:[1,.65,.2],c3:[1,.8,.3],c4:[1,.9,.5],c5:[1,1,.8]}},{name:"Grayscale",isMonotonic:!0,params:{type:"gradient",c1:[.01,.01,.03],c2:[.15,.15,.17],c3:[.45,.45,.45],c4:[.75,.74,.72],c5:[1,.98,.95]},hdrParams:{type:"gradient",c1:[1,1,1],c2:[1,1,1],c3:[1,1,1],c4:[1,1,1],c5:[1,1,1]}},{name:"Sepia",isMonotonic:!0,params:{type:"gradient",c1:[.03,.02,.01],c2:[.15,.08,.03],c3:[.4,.25,.12],c4:[.7,.55,.35],c5:[1,.95,.85]},hdrParams:{type:"gradient",c1:[1,.7,.4],c2:[1,.8,.55],c3:[1,.88,.7],c4:[1,.95,.85],c5:[1,1,.95]}},{name:"Ocean",isMonotonic:!0,params:{type:"gradient",c1:[0,.02,.05],c2:[.02,.08,.2],c3:[.05,.3,.4],c4:[.2,.6,.6],c5:[.6,.95,.9]},hdrParams:{type:"gradient",c1:[.1,.8,.8],c2:[.2,.9,.85],c3:[.4,.95,.9],c4:[.65,1,.95],c5:[.85,1,1]}},{name:"Purple",isMonotonic:!0,params:{type:"gradient",c1:[.03,.01,.06],c2:[.15,.05,.25],c3:[.4,.15,.5],c4:[.7,.4,.75],c5:[.95,.8,1]},hdrParams:{type:"gradient",c1:[.8,.2,1],c2:[.85,.4,1],c3:[.9,.6,1],c4:[.95,.8,1],c5:[1,.95,1]}},{name:"Forest",isMonotonic:!0,params:{type:"gradient",c1:[.02,.03,.01],c2:[.05,.12,.04],c3:[.1,.35,.15],c4:[.3,.65,.3],c5:[.7,.95,.6]},hdrParams:{type:"gradient",c1:[.3,1,.2],c2:[.5,1,.4],c3:[.7,1,.55],c4:[.85,1,.75],c5:[.95,1,.9]}}],P=j.length;function se(i){return D[i%I].params}function ae(i,e){const t=j[i%P];return e&&t.hdrParams?t.hdrParams:t.params}function Se(i){return D[i%I]}function we(i){return j[i%P]}function ke(i){return D[i%I].name}function Oe(i){return j[i%P].name}function G(i){const e=M(i),t=i>>1;let s;switch(t){case 0:s={juliaBlend:0,preAbsRe:0,preAbsIm:0,preNegIm:0,postAbsRe:0,postAbsIm:0,postNegIm:0};break;case 1:s={juliaBlend:0,preAbsRe:1,preAbsIm:1,preNegIm:1,postAbsRe:0,postAbsIm:0,postNegIm:0};break;case 2:s={juliaBlend:0,preAbsRe:0,preAbsIm:0,preNegIm:0,postAbsRe:0,postAbsIm:0,postNegIm:1};break;case 3:s={juliaBlend:0,preAbsRe:0,preAbsIm:0,preNegIm:0,postAbsRe:1,postAbsIm:0,postNegIm:0};break;case 4:s={juliaBlend:0,preAbsRe:0,preAbsIm:0,preNegIm:0,postAbsRe:1,postAbsIm:1,postNegIm:1};break;case 5:return null;case 6:return null;case 7:return null;case 8:s={juliaBlend:0,preAbsRe:0,preAbsIm:1,preNegIm:0,postAbsRe:0,postAbsIm:0,postNegIm:0};break;case 9:s={juliaBlend:0,preAbsRe:1,preAbsIm:0,preNegIm:0,postAbsRe:0,postAbsIm:0,postNegIm:1};break;default:return null}return s.juliaBlend=e?1:0,s}function z(i,e,t){return i+(e-i)*t}function Ae(i,e,t){return{juliaBlend:z(i.juliaBlend,e.juliaBlend,t),preAbsRe:z(i.preAbsRe,e.preAbsRe,t),preAbsIm:z(i.preAbsIm,e.preAbsIm,t),preNegIm:z(i.preNegIm,e.preNegIm,t),postAbsRe:z(i.postAbsRe,e.postAbsRe,t),postAbsIm:z(i.postAbsIm,e.postAbsIm,t),postNegIm:z(i.postNegIm,e.postNegIm,t)}}const Be=3e3,Y=3e3,Re=8e3,Ee=2e3,X=.5,_e=.25,q=2,$=.6,K=.5;function Le(i,e,t){if(i<q&&e<q)return F(i,e,t);const s=Math.min(i,e),a=Math.max(K,s*(1-$)+K*$);if(a>=s)return F(i,e,t);const r=Math.log(i),h=Math.log(e),d=Math.log(a),f=1-t,l=f*f*r+2*f*t*d+t*t*h;return Math.exp(l)}function V(i){return i<.5?4*i*i*i:1-Math.pow(-2*i+2,3)/2}function x(i,e,t){return i+(e-i)*t}function v(i,e,t){return[x(i[0],e[0],t),x(i[1],e[1],t),x(i[2],e[2],t)]}function De(i){return i.paletteType==="cosine"?se(i.cosinePaletteIndex):ae(i.gradientPaletteIndex,!1)}function je(i,e,t){if(i.type==="cosine"&&e.type==="cosine")return{type:"cosine",a:v(i.a,e.a,t),b:v(i.b,e.b,t),c:v(i.c,e.c,t),d:v(i.d,e.d,t)};if(i.type==="gradient"&&e.type==="gradient")return{type:"gradient",c1:v(i.c1,e.c1,t),c2:v(i.c2,e.c2,t),c3:v(i.c3,e.c3,t),c4:v(i.c4,e.c4,t),c5:v(i.c5,e.c5,t)};if(t<.5)if(i.type==="cosine"){const s=t*2;return{type:"cosine",a:v(i.a,[.5,.5,.5],s*.3),b:v(i.b,[.3,.3,.3],s*.3),c:i.c,d:i.d}}else return i;else if(e.type==="cosine"){const s=(t-.5)*2;return{type:"cosine",a:v([.5,.5,.5],e.a,s),b:v([.3,.3,.3],e.b,s),c:e.c,d:e.d}}else return e}function F(i,e,t){const s=Math.log(i),a=Math.log(e);return Math.exp(x(s,a,t))}function Z(i,e,t,s,a){const r=Math.sqrt(i*i+e*e),h=Math.sqrt(t*t+s*s);let d=Math.atan2(e,i),f=Math.atan2(s,t);const l=.01;if(r<l&&h<l)return[x(i,t,a),x(e,s,a)];if(r<l)return[x(0,t,a),x(0,s,a)];if(h<l)return[x(i,0,a),x(e,0,a)];let p=f-d;p>Math.PI?p-=2*Math.PI:p<-Math.PI&&(p+=2*Math.PI);const y=d+p*a,b=x(r,h,a);return[b*Math.cos(y),b*Math.sin(y)]}class E{constructor(e,t){n(this,"active",!1);n(this,"state",{type:"idle"});n(this,"animationFrameId",null);n(this,"callbacks");n(this,"currentTarget");n(this,"visitedLocations",new Set);n(this,"tick",e=>{this.active&&(this.updateAnimation(e),this.animationFrameId=requestAnimationFrame(this.tick))});this.callbacks=e,this.currentTarget=this.bookmarkToTarget(t)}bookmarkToTarget(e){return{centerX:e.centerX,centerY:e.centerY,zoom:e.zoom,fractalType:e.fractalType,paletteType:e.paletteType,cosinePaletteIndex:e.cosinePaletteIndex,gradientPaletteIndex:e.gradientPaletteIndex,paletteParams:De(e),colorOffset:e.colorOffset,juliaC:e.juliaC,blendParams:G(e.fractalType)}}start(e){this.active||(this.active=!0,this.currentTarget=this.bookmarkToTarget(e),this.visitedLocations.clear(),this.state={type:"paused",startTime:performance.now(),duration:1e3},this.animationFrameId=requestAnimationFrame(this.tick),console.log("🚀 Tourist mode started"))}stop(){this.active&&(this.active=!1,this.state={type:"idle"},this.animationFrameId!==null&&(cancelAnimationFrame(this.animationFrameId),this.animationFrameId=null),console.log("🛑 Tourist mode stopped"))}isActive(){return this.active}updateCurrentState(e){this.currentTarget=this.bookmarkToTarget(e)}animateToLocation(e,t){this.animationFrameId!==null&&(cancelAnimationFrame(this.animationFrameId),this.animationFrameId=null),this.active=!0,this.currentTarget=this.bookmarkToTarget(t),this.transitionTo(e,!0),this.animationFrameId=requestAnimationFrame(this.tick),console.log(`🎯 Animating to: ${e.name}`)}updateAnimation(e){switch(this.state.type){case"idle":this.pickNextDestination();break;case"paused":e-this.state.startTime>=this.state.duration&&this.pickNextDestination();break;case"transitioning":{const t=e-this.state.startTime,s=Math.min(1,t/this.state.duration),a=V(s),r=Z(this.state.from.juliaC[0],this.state.from.juliaC[1],this.state.to.juliaC[0],this.state.to.juliaC[1],a),h=this.state.from.zoom,d=this.state.to.zoom,f=Le(h,d,s),[l,p]=Z(this.state.from.centerX,this.state.from.centerY,this.state.to.centerX,this.state.to.centerY,a),y=je(this.state.from.paletteParams,this.state.to.paletteParams,a);let b=null;const u=this.state.from.blendParams,g=this.state.to.blendParams;u&&g?b=Ae(u,g,a):s>=.5&&g?b=g:s<.5&&u&&(b=u);const O={centerX:l,centerY:p,zoom:f,fractalType:this.state.to.fractalType,paletteType:this.state.to.paletteType,cosinePaletteIndex:this.state.to.cosinePaletteIndex,gradientPaletteIndex:this.state.to.gradientPaletteIndex,colorOffset:x(this.state.from.colorOffset,this.state.to.colorOffset,a),juliaC:r};this.currentTarget={...this.state.to,centerX:l,centerY:p,zoom:f,paletteParams:y,colorOffset:O.colorOffset,juliaC:r,blendParams:b},this.callbacks.onUpdate(O,y,b),this.callbacks.onRender(),s>=1&&(this.callbacks.onClearInterpolation(),this.state.singleTransition?(this.active=!1,this.state={type:"idle"},this.animationFrameId!==null&&(cancelAnimationFrame(this.animationFrameId),this.animationFrameId=null),console.log("🎯 Single transition complete")):this.state={type:"paused",startTime:e,duration:Be});break}case"zoomingOut":{const t=e-this.state.startTime,s=Math.min(1,t/this.state.duration),a=V(s),r=F(this.state.from.zoom,this.state.targetZoom,a),h={centerX:this.state.from.centerX,centerY:this.state.from.centerY,zoom:r};this.currentTarget={...this.currentTarget,zoom:r},this.callbacks.onUpdate(h),this.callbacks.onClearInterpolation(),this.callbacks.onRender(),s>=1&&(this.currentTarget.fractalType=this.state.nextFractalType,this.currentTarget.blendParams=G(this.state.nextFractalType),this.callbacks.onUpdate({fractalType:this.state.nextFractalType}),this.callbacks.onClearInterpolation(),this.visitedLocations.clear(),this.pickDestinationForCurrentFractal());break}}}pickNextDestination(){Math.random()<_e?this.initiateFractalSwitch():this.pickDestinationForCurrentFractal()}initiateFractalSwitch(){const t=k(this.currentTarget.fractalType)>>1;let s=Math.floor(Math.random()*S);s===t&&(s=(s+1)%S);const a=s<<1;if(this.currentTarget.zoom<=X*1.5){this.currentTarget.fractalType=a,this.callbacks.onUpdate({fractalType:a}),this.visitedLocations.clear(),this.pickDestinationForCurrentFractal();return}this.state={type:"zoomingOut",startTime:performance.now(),duration:Ee,from:{...this.currentTarget},targetZoom:X,nextFractalType:a}}pickDestinationForCurrentFractal(){const e=Ce(this.currentTarget.fractalType);if(e.length===0){this.currentTarget.fractalType=o.Mandelbrot,this.callbacks.onUpdate({fractalType:o.Mandelbrot}),this.pickDestinationForCurrentFractal();return}let t=e.filter(a=>!this.visitedLocations.has(this.getLocationKey(a)));t.length===0&&(this.visitedLocations.clear(),t=e);const s=t[Math.floor(Math.random()*t.length)];this.transitionTo(s)}getLocationKey(e){return`${e.state.fractalType}-${e.key}`}transitionTo(e,t=!1){const s=this.bookmarkToTarget(e.state),a=Math.abs(Math.log(s.zoom)-Math.log(this.currentTarget.zoom)),r=Math.sqrt(Math.pow(s.centerX-this.currentTarget.centerX,2)+Math.pow(s.centerY-this.currentTarget.centerY,2)),h=Math.min(Re,Math.max(Y,Y+a*500+r*2e3)),d=this.getLocationKey(e);this.visitedLocations.add(d),this.callbacks.onLocationNotification?.(e.name,e.description),this.state={type:"transitioning",startTime:performance.now(),duration:h,from:{...this.currentTarget},to:s,singleTransition:t}}}class Je{constructor(e){n(this,"element");n(this,"visible",!0);this.element=document.createElement("div"),this.element.id="zoom-debug",e.appendChild(this.element)}update(e){if(!this.visible)return;const t=e.zoom,s=t>=1e6?t.toExponential(2):t<1?t.toPrecision(4):String(Math.round(t)),a=e.isManualIterations?" (manual)":"",r=e.hdrEnabled?Math.abs(e.hdrBrightnessBias)>.01?`HDR (${e.hdrBrightnessBias>0?"+":""}${e.hdrBrightnessBias.toFixed(2)})`:"HDR":e.displaySupportsHDR?"HDR available":"SDR",h=!e.hdrEnabled&&e.paletteType==="gradient"&&Math.abs(e.sdrGradientBrightness-1)>.01?`brightness ${e.sdrGradientBrightness.toFixed(1)}`:"",d=e.juliaPickerMode?"🎯 Pick Julia point":"",f=e.isJulia?`c=(${e.juliaC[0].toFixed(4)}, ${e.juliaC[1].toFixed(4)})`:"",l=Math.abs(e.colorOffset)>.001?`offset ${e.colorOffset.toFixed(1)}`:"",p=[e.fractalName,`zoom ${s}`,`iterations ${e.maxIterations}${a}`,e.paletteName];l&&p.push(l),h&&p.push(h),f&&p.push(f),p.push(r),d&&p.push(d),p.push("H = help"),this.element.textContent=p.join("  ·  ")}show(){this.visible=!0,this.element.style.display="block"}hide(){this.visible=!1,this.element.style.display="none"}destroy(){this.element.remove()}}class Ne{constructor(e){n(this,"element");n(this,"frameCount",0);n(this,"fps",0);n(this,"lastUpdate",0);n(this,"updateInterval",500);n(this,"visible",!0);this.element=document.createElement("div"),this.element.id="fps-overlay",this.element.style.cssText=`
    ...
    `}destroy(){this.element.remove()}}class He{constructor(e){n(this,"element");n(this,"timeoutId",null);this.element=document.createElement("div"),this.element.id="share-notification",this.element.style.cssText=`
      position: fixed; top: 50%; left: 50%; transform: translate(-50%, -50%);
...
//# sourceMappingURL=index-BgrOSbbG.js.map
