var $=Object.defineProperty;var q=(i,e,t)=>e in i?$(i,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):i[e]=t;var s=(i,e,t)=>q(i,typeof e!="symbol"?e+"":e,t);(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))n(o);new MutationObserver(o=>{for(const c of o)if(c.type==="childList")for(const a of c.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&n(a)}).observe(document,{childList:!0,subtree:!0});function t(o){const c={};return o.integrity&&(c.integrity=o.integrity),o.referrerPolicy&&(c.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?c.credentials="include":o.crossOrigin==="anonymous"?c.credentials="omit":c.credentials="same-origin",c}function n(o){if(o.ep)return;o.ep=!0;const c=t(o);fetch(o.href,c)}})();class I{constructor(e){s(this,"device");s(this,"context");s(this,"canvas");s(this,"format");s(this,"animationFrameId",null);s(this,"renderCallback",null);s(this,"hdrEnabled",!1);s(this,"_displaySupportsHDR",!1);s(this,"hdrMediaQuery",null);s(this,"onHdrChangeCallback",null);this.canvas=e,this._displaySupportsHDR=this.detectHDRDisplay(),this.setupHdrMediaQueryListener()}get displaySupportsHDR(){return this._displaySupportsHDR}static async create(e){const t=new I(e);return await t.initialize(),t}static isSupported(){return"gpu"in navigator}async initialize(){if(!navigator.gpu)throw new Error("WebGPU is not supported in this browser");console.log("WebGPU HDR capability check:"),console.log("  - Display supports HDR:",this.displaySupportsHDR),console.log("  - dynamic-range: high:",window.matchMedia?.("(dynamic-range: high)").matches),console.log("  - color-gamut: p3:",window.matchMedia?.("(color-gamut: p3)").matches);const e=await navigator.gpu.requestAdapter({powerPreference:"high-performance"});if(!e)throw new Error("Failed to get WebGPU adapter");if("info"in e){const t=e.info;console.log("  - Adapter:",t?.vendor,t?.architecture)}if(this.device=await e.requestDevice(),this.context=this.canvas.getContext("webgpu"),!this.context)throw new Error("Failed to get WebGPU context");this.configureContext(),console.log("WebGPU initialized successfully"),this.hdrEnabled&&console.log("HDR mode enabled with rgba16float + extended tone mapping")}configureContext(){const e=navigator.gpu.getPreferredCanvasFormat();if(this.displaySupportsHDR)try{this.format="rgba16float",this.context.configure({device:this.device,format:this.format,alphaMode:"opaque",toneMapping:{mode:"extended"}}),this.hdrEnabled=!0,console.log("  - Configured with rgba16float + extended tone mapping (HDR)")}catch(t){console.log("  - HDR configuration failed, falling back to SDR:",t),this.format=e,this.context.configure({device:this.device,format:this.format,alphaMode:"opaque"}),this.hdrEnabled=!1}else this.format=e,this.context.configure({device:this.device,format:this.format,alphaMode:"opaque"}),this.hdrEnabled=!1,console.log("  - Configured with",this.format,"(SDR)")}resize(e,t){const n=window.devicePixelRatio||1;this.canvas.width=e*n,this.canvas.height=t*n,this.canvas.style.width=`${e}px`,this.canvas.style.height=`${t}px`}getCurrentTexture(){return this.context.getCurrentTexture()}start(e){if(this.animationFrameId!==null)return;this.renderCallback=e;const t=()=>{this.renderCallback&&this.renderCallback(),this.animationFrameId=requestAnimationFrame(t)};this.animationFrameId=requestAnimationFrame(t)}stop(){this.animationFrameId!==null&&(cancelAnimationFrame(this.animationFrameId),this.animationFrameId=null),this.renderCallback=null}detectHDRDisplay(){return!!window.matchMedia?.("(dynamic-range: high)").matches}setupHdrMediaQueryListener(){if(!window.matchMedia)return;this.hdrMediaQuery=window.matchMedia("(dynamic-range: high)");const e=()=>{const t=this.detectHDRDisplay();t!==this._displaySupportsHDR&&(console.log(`HDR display support changed: ${this._displaySupportsHDR} -> ${t}`),this._displaySupportsHDR=t,this.context&&this.device&&this.configureContext(),this.onHdrChangeCallback?.())};this.hdrMediaQuery.addEventListener?.("change",e)}setOnHdrChange(e){this.onHdrChangeCallback=e}destroy(){this.stop(),this.onHdrChangeCallback=null,this.device?.destroy()}}class V{constructor(e=-.5,t=0,n=.4){s(this,"centerX");s(this,"centerY");s(this,"zoom");this.centerX=e,this.centerY=t,this.zoom=n}pan(e,t,n,o){const c=-e/(this.zoom*n),a=t/(this.zoom*o);this.centerX+=c,this.centerY+=a}zoomAt(e,t,n,o,c){const a=this.centerX+(e/o-.5)/this.zoom,h=this.centerY-(t/c-.5)/this.zoom;this.zoom*=n,this.zoom=Math.max(.1,Math.min(this.zoom,1e15));const f=this.centerX+(e/o-.5)/this.zoom,p=this.centerY-(t/c-.5)/this.zoom;this.centerX+=a-f,this.centerY+=h-p}toFractalCoords(e,t,n,o){const c=n/o,a=(e/n-.5)*c,h=t/o-.5,f=this.centerX+a/this.zoom,p=this.centerY-h/this.zoom;return[f,p]}toScreenCoords(e,t,n,o){const c=n/o,a=(e-this.centerX)*this.zoom,h=(t-this.centerY)*this.zoom,f=(a/c+.5)*n,p=(-h+.5)*o;return[f,p]}zoomToPoint(e,t,n,o,c){const[a,h]=this.toFractalCoords(e,t,o,c);this.centerX=a,this.centerY=h,this.zoom*=n,this.zoom=Math.max(.1,Math.min(this.zoom,1e15))}reset(){this.centerX=-.5,this.centerY=0,this.zoom=.4}}const Z=.6;function O(i){return 1+(i-1)*Z}class W{constructor(e,t,n){s(this,"canvas");s(this,"viewState");s(this,"onChange");s(this,"onIterationAdjust",null);s(this,"onIterationReset",null);s(this,"onCosinePaletteCycle",null);s(this,"onGradientPaletteCycle",null);s(this,"onColorOffset",null);s(this,"onColorOffsetReset",null);s(this,"onToggleAA",null);s(this,"onAdjustHdrBrightness",null);s(this,"onResetHdrBrightness",null);s(this,"onFractalCycle",null);s(this,"onToggleJuliaMode",null);s(this,"onJuliaPick",null);s(this,"onJuliaPickEnd",null);s(this,"onShare",null);s(this,"onLocationSelect",null);s(this,"onToggleHelp",null);s(this,"onToggleScreenshotMode",null);s(this,"isDragging",!1);s(this,"lastX",0);s(this,"lastY",0);s(this,"lastTouchDistance",0);s(this,"juliaPickerMode",!1);s(this,"isPickingJulia",!1);s(this,"juliaPickViewState",null);s(this,"keyboardZoomDirection",null);s(this,"keyboardZoomStartTime",0);s(this,"keyboardZoomAnimationId",null);this.canvas=e,this.viewState=t,this.onChange=n,this.setupEventListeners()}setIterationAdjustCallback(e){this.onIterationAdjust=e}setIterationResetCallback(e){this.onIterationReset=e}setCosinePaletteCycleCallback(e){this.onCosinePaletteCycle=e}setGradientPaletteCycleCallback(e){this.onGradientPaletteCycle=e}setColorOffsetCallback(e){this.onColorOffset=e}setColorOffsetResetCallback(e){this.onColorOffsetReset=e}setToggleAACallback(e){this.onToggleAA=e}setToggleHDRCallback(e){}setAdjustHdrBrightnessCallback(e){this.onAdjustHdrBrightness=e}setResetHdrBrightnessCallback(e){this.onResetHdrBrightness=e}setFractalCycleCallback(e){this.onFractalCycle=e}setToggleJuliaModeCallback(e){this.onToggleJuliaMode=e}setJuliaPickCallback(e){this.onJuliaPick=e}setJuliaPickEndCallback(e){this.onJuliaPickEnd=e}setShareCallback(e){this.onShare=e}setLocationSelectCallback(e){this.onLocationSelect=e}setToggleHelpCallback(e){this.onToggleHelp=e}setToggleScreenshotModeCallback(e){this.onToggleScreenshotMode=e}setJuliaPickerMode(e){this.juliaPickerMode=e,this.canvas.style.cursor=e?"crosshair":"grab"}isJuliaPickerModeActive(){return this.juliaPickerMode}setupEventListeners(){this.canvas.addEventListener("mousedown",this.handleMouseDown.bind(this)),this.canvas.addEventListener("mousemove",this.handleMouseMove.bind(this)),this.canvas.addEventListener("mouseup",this.handleMouseUp.bind(this)),this.canvas.addEventListener("mouseleave",this.handleMouseUp.bind(this)),this.canvas.addEventListener("wheel",this.handleWheel.bind(this),{passive:!1}),this.canvas.addEventListener("dblclick",this.handleDoubleClick.bind(this)),this.canvas.addEventListener("touchstart",this.handleTouchStart.bind(this),{passive:!1}),this.canvas.addEventListener("touchmove",this.handleTouchMove.bind(this),{passive:!1}),this.canvas.addEventListener("touchend",this.handleTouchEnd.bind(this)),this.canvas.addEventListener("touchcancel",this.handleTouchEnd.bind(this)),window.addEventListener("keydown",this.handleKeyDown.bind(this)),window.addEventListener("keyup",this.handleKeyUp.bind(this))}getCanvasRect(){return this.canvas.getBoundingClientRect()}getScreenCoords(e,t){const n=this.getCanvasRect();return[e-n.left,t-n.top]}getCanvasSize(){const e=this.getCanvasRect();return[e.width,e.height]}toFractalCoordsWithView(e,t,n,o,c){const a=n/o,h=(e/n-.5)*a,f=t/o-.5,p=c.centerX+h/c.zoom,d=c.centerY-f/c.zoom;return[p,d]}notifyChange(){this.onChange(this.viewState)}handleMouseDown(e){if(e.button!==0)return;const[t,n]=this.getScreenCoords(e.clientX,e.clientY);if(this.juliaPickerMode&&this.onJuliaPick){const[o,c]=this.getCanvasSize();this.juliaPickViewState={centerX:this.viewState.centerX,centerY:this.viewState.centerY,zoom:this.viewState.zoom};const[a,h]=this.toFractalCoordsWithView(t,n,o,c,this.juliaPickViewState);this.isPickingJulia=!0,this.lastX=t,this.lastY=n,this.onJuliaPick(a,h);return}this.isDragging=!0,this.lastX=t,this.lastY=n,this.canvas.style.cursor="grabbing"}handleMouseMove(e){const[t,n]=this.getScreenCoords(e.clientX,e.clientY);if(this.isPickingJulia&&this.onJuliaPick&&this.juliaPickViewState){const[f,p]=this.getCanvasSize(),[d,y]=this.toFractalCoordsWithView(t,n,f,p,this.juliaPickViewState);this.onJuliaPick(d,y),this.lastX=t,this.lastY=n;return}if(!this.isDragging)return;const o=t-this.lastX,c=n-this.lastY,[a,h]=this.getCanvasSize();this.viewState.pan(o,c,a,h),this.notifyChange(),this.lastX=t,this.lastY=n}handleMouseUp(){if(this.isPickingJulia){this.isPickingJulia=!1,this.juliaPickViewState=null,this.onJuliaPickEnd?.();return}this.isDragging&&(this.isDragging=!1,this.canvas.style.cursor="grab")}handleWheel(e){e.preventDefault();const[t,n]=this.getScreenCoords(e.clientX,e.clientY),o=e.deltaY>0?.9:1.1,c=O(o),[a,h]=this.getCanvasSize();this.viewState.zoomAt(t,n,c,a,h),this.notifyChange()}handleDoubleClick(e){const[t,n]=this.getScreenCoords(e.clientX,e.clientY),[o,c]=this.getCanvasSize();this.viewState.zoomToPoint(t,n,O(2),o,c),this.notifyChange()}getTouchDistance(e){if(e.length<2)return 0;const t=e[0].clientX-e[1].clientX,n=e[0].clientY-e[1].clientY;return Math.sqrt(t*t+n*n)}getTouchCenter(e){if(e.length===0)return[0,0];if(e.length===1)return this.getScreenCoords(e[0].clientX,e[0].clientY);const t=(e[0].clientX+e[1].clientX)/2,n=(e[0].clientY+e[1].clientY)/2;return this.getScreenCoords(t,n)}handleTouchStart(e){if(e.touches.length===1){this.isDragging=!0;const[t,n]=this.getScreenCoords(e.touches[0].clientX,e.touches[0].clientY);this.lastX=t,this.lastY=n}else e.touches.length===2&&(this.isDragging=!1,this.lastTouchDistance=this.getTouchDistance(e.touches))}handleTouchMove(e){if(e.preventDefault(),e.touches.length===1&&this.isDragging){const[t,n]=this.getScreenCoords(e.touches[0].clientX,e.touches[0].clientY),o=t-this.lastX,c=n-this.lastY,[a,h]=this.getCanvasSize();this.viewState.pan(o,c,a,h),this.notifyChange(),this.lastX=t,this.lastY=n}else if(e.touches.length===2){const t=this.getTouchDistance(e.touches),n=this.getTouchCenter(e.touches);if(this.lastTouchDistance>0){const o=t/this.lastTouchDistance,c=O(o),[a,h]=this.getCanvasSize();this.viewState.zoomAt(n[0],n[1],c,a,h),this.notifyChange()}this.lastTouchDistance=t}}handleTouchEnd(){this.isDragging=!1,this.lastTouchDistance=0}handleKeyDown(e){if(!(e.target instanceof HTMLInputElement||e.target instanceof HTMLTextAreaElement))switch(e.key){case"+":case"=":e.preventDefault(),this.onIterationAdjust?.(1);break;case"-":case"_":e.preventDefault(),this.onIterationAdjust?.(-1);break;case"0":e.preventDefault(),this.onIterationReset?.();break;case"c":e.preventDefault(),this.onCosinePaletteCycle?.(1);break;case"C":e.preventDefault(),this.onCosinePaletteCycle?.(-1);break;case"g":e.preventDefault(),this.onGradientPaletteCycle?.(1);break;case"G":e.preventDefault(),this.onGradientPaletteCycle?.(-1);break;case"[":case",":e.preventDefault(),this.onColorOffset?.(-.05);break;case"]":case".":e.preventDefault(),this.onColorOffset?.(.05);break;case"{":case"<":e.preventDefault(),this.onColorOffset?.(-.15);break;case"}":case">":e.preventDefault(),this.onColorOffset?.(.15);break;case"r":case"R":e.preventDefault(),this.onColorOffsetReset?.();break;case"a":case"A":e.preventDefault(),this.onToggleAA?.();break;case"b":e.preventDefault(),this.onAdjustHdrBrightness?.(1);break;case"B":e.preventDefault(),this.onAdjustHdrBrightness?.(-1);break;case"d":e.preventDefault(),this.onResetHdrBrightness?.();break;case"f":e.preventDefault(),this.onFractalCycle?.(1);break;case"F":e.preventDefault(),this.onFractalCycle?.(-1);break;case"j":case"J":e.preventDefault(),this.onToggleJuliaMode?.();break;case"s":case"S":e.preventDefault(),this.onShare?.();break;case"1":case"2":case"3":case"4":case"5":case"6":case"7":case"8":case"9":e.preventDefault(),this.onLocationSelect?.(e.key);break;case"h":case"H":e.preventDefault(),this.onToggleHelp?.();break;case" ":e.preventDefault(),this.onToggleScreenshotMode?.();break;case"z":e.preventDefault(),e.repeat||this.startKeyboardZoom(1);break;case"Z":e.preventDefault(),e.repeat||this.startKeyboardZoom(-1);break}}handleKeyUp(e){(e.key==="z"||e.key==="Z")&&this.stopKeyboardZoom()}startKeyboardZoom(e){this.keyboardZoomAnimationId!==null&&this.stopKeyboardZoom(),this.keyboardZoomDirection=e,this.keyboardZoomStartTime=performance.now(),this.keyboardZoomAnimationId=requestAnimationFrame(this.keyboardZoomLoop.bind(this))}stopKeyboardZoom(){this.keyboardZoomAnimationId!==null&&(cancelAnimationFrame(this.keyboardZoomAnimationId),this.keyboardZoomAnimationId=null),this.keyboardZoomDirection=null}keyboardZoomLoop(e){if(this.keyboardZoomDirection===null)return;const t=e-this.keyboardZoomStartTime;this.keyboardZoomStartTime=e;const o=this.keyboardZoomDirection*.7*(t/1e3),c=Math.exp(o),[a,h]=this.getCanvasSize();this.viewState.zoomAt(a/2,h/2,c,a,h),this.notifyChange(),this.keyboardZoomAnimationId=requestAnimationFrame(this.keyboardZoomLoop.bind(this))}destroy(){}}var r=(i=>(i[i.Mandelbrot=0]="Mandelbrot",i[i.MandelbrotJulia=1]="MandelbrotJulia",i[i.BurningShip=2]="BurningShip",i[i.BurningShipJulia=3]="BurningShipJulia",i[i.Tricorn=4]="Tricorn",i[i.TricornJulia=5]="TricornJulia",i[i.Celtic=6]="Celtic",i[i.CelticJulia=7]="CelticJulia",i[i.Buffalo=8]="Buffalo",i[i.BuffaloJulia=9]="BuffaloJulia",i[i.Phoenix=10]="Phoenix",i[i.PhoenixJulia=11]="PhoenixJulia",i[i.Multibrot3=12]="Multibrot3",i[i.Multibrot3Julia=13]="Multibrot3Julia",i[i.Multibrot4=14]="Multibrot4",i[i.Multibrot4Julia=15]="Multibrot4Julia",i[i.Funky=16]="Funky",i[i.FunkyJulia=17]="FunkyJulia",i[i.Perpendicular=18]="Perpendicular",i[i.PerpendicularJulia=19]="PerpendicularJulia",i))(r||{});const K={0:"Mandelbrot",1:"Mandelbrot Julia",2:"Burning Ship",3:"Burning Ship Julia",4:"Tricorn",5:"Tricorn Julia",6:"Celtic",7:"Celtic Julia",8:"Buffalo",9:"Buffalo Julia",10:"Phoenix",11:"Phoenix Julia",12:"Multibrot (z³)",13:"Multibrot³ Julia",14:"Multibrot (z⁴)",15:"Multibrot⁴ Julia",16:"Funky",17:"Funky Julia",18:"Perpendicular",19:"Perpendicular Julia"},J=10;function z(i){return(i&1)===1}function M(i){return i&-2}function Q(i){return i|1}const u={TYPE:"t",CENTER_X:"x",CENTER_Y:"y",ZOOM:"z",PALETTE:"p",PALETTE_TYPE:"pt",COSINE_PALETTE:"cp",GRADIENT_PALETTE:"gp",COLOR_OFFSET:"o",JULIA_REAL:"jr",JULIA_IMAG:"ji",ITERATIONS:"i",AA:"aa"};function x(i,e=15){return i===0?"0":Math.abs(i)<1e-10||Math.abs(i)>1e10?i.toExponential(e):parseFloat(i.toPrecision(e)).toString()}function g(i){if(i===null||i==="")return null;const e=parseFloat(i);return isNaN(e)?null:e}function N(i){const e=new URLSearchParams;return e.set(u.TYPE,i.fractalType.toString()),e.set(u.CENTER_X,x(i.centerX)),e.set(u.CENTER_Y,x(i.centerY)),e.set(u.ZOOM,x(i.zoom)),e.set(u.PALETTE_TYPE,i.paletteType==="cosine"?"c":"g"),e.set(u.COSINE_PALETTE,i.cosinePaletteIndex.toString()),e.set(u.GRADIENT_PALETTE,i.gradientPaletteIndex.toString()),Math.abs(i.colorOffset)>.001&&e.set(u.COLOR_OFFSET,x(i.colorOffset,4)),z(i.fractalType)&&(e.set(u.JULIA_REAL,x(i.juliaC[0])),e.set(u.JULIA_IMAG,x(i.juliaC[1]))),i.maxIterationsOverride!==null&&e.set(u.ITERATIONS,i.maxIterationsOverride.toString()),i.aaEnabled&&e.set(u.AA,"1"),e.toString()}function ee(i){const e=new URLSearchParams(i.replace(/^#/,"")),t={},n=g(e.get(u.TYPE));n!==null&&n>=0&&n<=19&&(t.fractalType=n);const o=g(e.get(u.CENTER_X));o!==null&&(t.centerX=o);const c=g(e.get(u.CENTER_Y));c!==null&&(t.centerY=c);const a=g(e.get(u.ZOOM));a!==null&&a>0&&(t.zoom=a);const h=e.get(u.PALETTE_TYPE);(h==="c"||h==="g")&&(t.paletteType=h==="c"?"cosine":"gradient");const f=g(e.get(u.COSINE_PALETTE));f!==null&&f>=0&&(t.cosinePaletteIndex=Math.floor(f));const p=g(e.get(u.GRADIENT_PALETTE));p!==null&&p>=0&&(t.gradientPaletteIndex=Math.floor(p));const d=g(e.get(u.PALETTE));d!==null&&d>=0&&d<=11&&(t.paletteIndex=Math.floor(d));const y=g(e.get(u.COLOR_OFFSET));y!==null&&(t.colorOffset=y);const S=g(e.get(u.JULIA_REAL)),b=g(e.get(u.JULIA_IMAG));S!==null&&b!==null&&(t.juliaC=[S,b]);const m=g(e.get(u.ITERATIONS));return m!==null&&m>0&&(t.maxIterationsOverride=Math.floor(m)),e.get(u.AA)==="1"&&(t.aaEnabled=!0),t}function te(i){const e=N(i),t=new URL(window.location.href);return t.hash=e,t.toString()}function ie(i){const e=N(i);window.history.replaceState(null,"","#"+e)}function ne(){return ee(window.location.hash)}async function ae(i){const e=te(i);try{return await navigator.clipboard.writeText(e),!0}catch{const t=document.createElement("textarea");t.value=e,t.style.position="fixed",t.style.left="-9999px",document.body.appendChild(t),t.select();try{return document.execCommand("copy"),!0}catch{return!1}finally{document.body.removeChild(t)}}}function l(i,e,t,n,o,c,a,h={}){return{name:i,description:e,key:t,state:{fractalType:n,centerX:o,centerY:c,zoom:a,paletteType:h.paletteType??"cosine",cosinePaletteIndex:h.cosinePaletteIndex??1,gradientPaletteIndex:h.gradientPaletteIndex??0,colorOffset:h.colorOffset??0,juliaC:h.juliaC??[-.7,.27015],maxIterationsOverride:h.maxIterationsOverride??null,aaEnabled:!1}}}const re=[l("Mandelbrot","The famous Mandelbrot set","1",r.Mandelbrot,-.5,0,.4),l("Seahorse Valley","The iconic seahorse-shaped spirals","2",r.Mandelbrot,-.7581249305506096,.11244273987387937,36.41989684959737,{cosinePaletteIndex:5,colorOffset:.05}),l("Elephant Valley","Elephant trunk-like spirals on the positive real side","3",r.Mandelbrot,.2746341335933571,.0066936145282295205,212.15493874953236,{cosinePaletteIndex:3,colorOffset:-.1}),l("Double Spiral Valley","Beautiful double spirals deep in the set","4",r.Mandelbrot,-.743733589978665,.130905227502858,350,{cosinePaletteIndex:5,colorOffset:.15000000000000002}),l("Spiral Galaxy","Galactic spiral arms emerging from chaos","5",r.Mandelbrot,-.7615484049386866,-.08478444765887823,1506.4927460380957,{cosinePaletteIndex:4,colorOffset:.04999999999999999}),l("Douady Rabbit","The famous rabbit-eared Julia set","6",r.MandelbrotJulia,0,0,.6,{cosinePaletteIndex:4,colorOffset:.2,juliaC:[-.123,.745]}),l("Dragon Julia","Fierce dragon-like Julia set","7",r.MandelbrotJulia,0,0,.45,{cosinePaletteIndex:3,colorOffset:-.49999999999999994,juliaC:[-.8,.156]}),l("Spiral Julia","Delicate spiral arms from the main cardioid edge","8",r.MandelbrotJulia,0,0,.5,{cosinePaletteIndex:8,colorOffset:.65,juliaC:[-.75,.11]}),l("Dendrite Julia","Tree-like branching structure on the real axis","9",r.MandelbrotJulia,0,0,.41791083585808675,{cosinePaletteIndex:5,colorOffset:.1,juliaC:[.285,.01]})],se=[l("Main Ship","The iconic burning ship silhouette","1",r.BurningShip,-.6819541375872399,.5906040268456356,.4,{cosinePaletteIndex:4,colorOffset:.3}),l("The Armada","Mini ships along the antenna","2",r.BurningShip,-1.80173025652805,.0153452534367207,9,{cosinePaletteIndex:4,colorOffset:.2}),l("Bow Detail","Intricate patterns at the ship's bow","3",r.BurningShip,-1.7500929615866607,.0368035491770765,10,{cosinePaletteIndex:10,colorOffset:.1}),l("Bacteria Worm","Worm-like structures with mosaic patterns","4",r.BurningShipJulia,0,0,.3,{cosinePaletteIndex:10,colorOffset:-.5499999999999998,juliaC:[.5179709888623353,.8057669844188748]}),l("Wispy Coils","Wispy coils near the bulbous extrusion from the ship","5",r.BurningShipJulia,0,0,.4,{cosinePaletteIndex:4,colorOffset:.35,juliaC:[.2525994076160102,.0006358222328731386]}),l("Space Brain","Brain-like structures from the bottom of the ship","6",r.BurningShipJulia,0,0,.7,{cosinePaletteIndex:5,colorOffset:.3,juliaC:[-1.059944784917394,-.033218825489255054]}),l("Spiral Patterns","Spiral patterns near the bulbous extrusion","7",r.BurningShipJulia,0,0,.41,{cosinePaletteIndex:11,colorOffset:.55,juliaC:[.28292507376881926,-.007597008191683113]}),l("Detailed Patterns","Beautiful detailed patterns near the bottom of the ship","8",r.BurningShipJulia,0,0,.5,{cosinePaletteIndex:2,colorOffset:.6,juliaC:[-.3967192382583807,-.09102348993288789]})],oe=[l("Tricorn","The main tricorn shape with its distinctive three-cornered symmetry","1",r.Tricorn,-.1343398614022916,-.07051105375213641,.24,{cosinePaletteIndex:11,colorOffset:-.45}),l("Skewed Mandelbrot","Skewed Mandelbrot from one of the main bulbs","2",r.Tricorn,-1.0683098234816064,.13055543771605108,722.5553792774821,{cosinePaletteIndex:5,colorOffset:1.1}),l("Lightning Bolts","Lightning bolt-like patterns near the main cardioid edge","3",r.TricornJulia,0,0,.5,{cosinePaletteIndex:5,colorOffset:1.2,juliaC:[-.7092474160797806,-.113024316756254]}),l("Water Lily Leaf","Leaf-like structures from the center of the edge of the main cardioid","4",r.TricornJulia,0,0,.43,{colorOffset:-.7000000000000003,juliaC:[-.1254330794660274,.2407433439223678]}),l("Lightning Brain","Brain-like structures","5",r.TricornJulia,0,0,3.15,{cosinePaletteIndex:5,juliaC:[.8748878776979363,-1.515483485507111]}),l("Spiral Mosaic","Mosaic patterns from the base of one of the main bulbs","6",r.TricornJulia,0,0,.5,{cosinePaletteIndex:11,colorOffset:1.55,juliaC:[-.5647012802389192,-.06508603367125808]}),l("Electric Tendrils","Electric tendril patterns with bright highlights","7",r.TricornJulia,0,0,.5,{cosinePaletteIndex:4,colorOffset:.05,juliaC:[-.511125124692869,.0500484416152959]})],le=[l("Celtic Knot","The main Celtic fractal shape","1",r.Celtic,-.5,0,.25,{cosinePaletteIndex:10,colorOffset:.05}),l("Celtic Detail","Intricate knotwork patterns","2",r.Celtic,-.7803221774980102,.1635662989215261,119.01480682794772,{cosinePaletteIndex:10,colorOffset:.25,maxIterationsOverride:1e4}),l("Leafy Spirals","Symmetric shapes from the tip of the celtic shape","3",r.CelticJulia,0,0,.55,{cosinePaletteIndex:7,colorOffset:.1,juliaC:[.25345198072532704,.0001580704105713714]}),l("Tendrils","Tendrils emerging from fog","4",r.CelticJulia,-.1649932591722856,-.033582161161888655,.28,{cosinePaletteIndex:5,juliaC:[-.4530201342281876,-.8993288590604025]}),l("Electric Buzz","Electric patterns with uniform patterned regions","5",r.CelticJulia,.2,-.3,.55,{colorOffset:.2000000000000001,juliaC:[-.6378073937333775,1.2082886796996293]}),l("Intricate Patterns","Knotwork patterns with intricate details","6",r.CelticJulia,0,0,.52,{cosinePaletteIndex:10,colorOffset:3.299999999999996,juliaC:[-.7610237673309276,.12050023730653406]}),l("Petri Dish","Bacteria-like patterns that spread outwards","7",r.CelticJulia,0,0,.55,{cosinePaletteIndex:10,colorOffset:4.449999999999991,juliaC:[-1.056655765809614,-.16855216053399263]})],ce=[l("Buffalo Overview","The distinctive Buffalo fractal shape","1",r.Buffalo,-.7,.6,.4,{cosinePaletteIndex:2,colorOffset:.49999999999999994}),l("Overgrown Cities","Tree or cathedral-like structures emerging from real axis","2",r.Buffalo,-1.75,.13,2.4,{colorOffset:-5}),l("Industrial Snowflake","Snowflake-like patterns with industrial structures woven in","3",r.BuffaloJulia,.45,0,.85,{cosinePaletteIndex:4,colorOffset:-9.1,juliaC:[-1.62727125821226,.00873720402364775]}),l("Plasma Bursts","Plasma-like bursts of color","4",r.BuffaloJulia,0,0,.5,{cosinePaletteIndex:8,colorOffset:-.75,juliaC:[.2745030250648227,.1797320656871218]}),l("Intricate Patterns","Intricate patterns near the bottom of the main shape","5",r.BuffaloJulia,0,0,.5,{cosinePaletteIndex:4,colorOffset:4.25,juliaC:[-.5828307625231954,-.3049842077590671]})],he=[l("Phoenix Overview","The Phoenix parameter space","1",r.Phoenix,-.15,-.7,.25,{cosinePaletteIndex:5,colorOffset:-.65}),l("Classic Phoenix Julia","The iconic feathery Phoenix fractal","2",r.PhoenixJulia,0,0,.5,{cosinePaletteIndex:2,colorOffset:.45,juliaC:[-.5,.5667],maxIterationsOverride:1152}),l("Phoenix Feathers","Detailed feather-like structures","3",r.PhoenixJulia,.38,.07,3.4,{cosinePaletteIndex:5,juliaC:[-.5,.5667]}),l("Golden Weaves","Bright golden patterns with intricate weaves","4",r.PhoenixJulia,0,.08,.4,{cosinePaletteIndex:2,colorOffset:.35,juliaC:[.656142759731905,.0353380147311402]}),l("Fiery Phoenix","Fiery wings spreading outwards","5",r.PhoenixJulia,0,-.03,.6,{cosinePaletteIndex:4,colorOffset:-1.7,juliaC:[-.272349453272398,.4059142585519806]})],de=[l("Multibrot³ Overview","The three-fold symmetric z³ Multibrot","1",r.Multibrot3,0,0,.35,{cosinePaletteIndex:5,colorOffset:2.35}),l("The Bulb","A bulbous extrusion from the main shape","2",r.Multibrot3,.5852686308492299,.27,6,{colorOffset:.10000000000000002}),l("Three-fold Spirals","Bright pearly spirals with three-fold symmetry","3",r.Multibrot3Julia,0,0,.4,{cosinePaletteIndex:10,colorOffset:.15,juliaC:[.5448826747676219,.26362559338015445]}),l("Multibrot³ Julia","A Julia set with three-fold symmetry","4",r.Multibrot3Julia,0,0,.434,{cosinePaletteIndex:5,colorOffset:.10000000000000002,juliaC:[-.45963436785036077,.03389484474578987]}),l("Double Elephant Valley","Two elephants in each group","5",r.Multibrot3,.42814685603247177,.012748071569601296,77,{cosinePaletteIndex:3,colorOffset:1}),l("Wonky Spiral","Wonky spiral Julia structure from inside the main set","6",r.Multibrot3Julia,.3695408370900379,.3371264555793177,2.274691481464049,{cosinePaletteIndex:0,colorOffset:0,juliaC:[.5277614770068884,.15853942850341446],maxIterationsOverride:2124}),l("Spiral Galaxies","The wonky spiral Julia structure viewed as galaxies","7",r.Multibrot3Julia,0,0,.4,{paletteType:"gradient",juliaC:[.5277614770068884,.15853942850341446],maxIterationsOverride:1152})],ue=[l("Multibrot⁴ Overview","The four-fold symmetric z⁴ Multibrot","1",r.Multibrot4,0,0,.4,{cosinePaletteIndex:5,colorOffset:0}),l("Atomic Spirals","Structures resembling atomic orbitals with spiral patterns","2",r.Multibrot4Julia,0,-0,.35,{cosinePaletteIndex:5,colorOffset:.4,juliaC:[-.7878865573262246,.02073442187254452]})],fe=[l("Funky Overview","The wonderfully weird Funky fractal","1",r.Funky,-.5,0,.35,{cosinePaletteIndex:4,colorOffset:.25}),l("Tulip Bulb","Extrusions resembling tulips near the top of the main shape","2",r.Funky,.303,.534,6.3,{cosinePaletteIndex:10,colorOffset:-.05000000000000002}),l("Battleship","Spaceship-like structure with double turrets all around","3",r.FunkyJulia,0,0,.45,{cosinePaletteIndex:4,colorOffset:-.7,juliaC:[-1.02568231965141,.128286053018475]}),l("Frog Crab","Crablike structure with brain-like spiral patterns within it","4",r.FunkyJulia,0,0,.37,{colorOffset:.1,juliaC:[.30191025227457674,.5253550579235958]}),l("Spiral Details","Beautiful spiral details without too much clutter","5",r.FunkyJulia,-.2,0,.4,{cosinePaletteIndex:5,colorOffset:.6,juliaC:[-.06404194046216194,.662960137583706]}),l("Migrating Birds","Bird-like shapes flying in formation","6",r.FunkyJulia,.34,0,.35,{cosinePaletteIndex:5,colorOffset:4.4,juliaC:[.5804003550040334,-.9094296635818582]})],pe=[l("Perpendicular Overview","The Perpendicular Mandelbrot variant","1",r.Perpendicular,-.5,0,.4,{cosinePaletteIndex:2,colorOffset:0}),l("Perpendicular Spirals","Unique spiral formations","2",r.Perpendicular,-.75,.1,8,{cosinePaletteIndex:4,colorOffset:.1}),l("Perpendicular Julia","A Julia set from the Perpendicular fractal","3",r.PerpendicularJulia,0,0,.5,{cosinePaletteIndex:0,colorOffset:0,juliaC:[-.5,.5]})],ge=new Map([[r.Mandelbrot,re],[r.BurningShip,se],[r.Tricorn,oe],[r.Celtic,le],[r.Buffalo,ce],[r.Phoenix,he],[r.Multibrot3,de],[r.Multibrot4,ue],[r.Funky,fe],[r.Perpendicular,pe]]);function me(i,e){const t=M(e),n=ge.get(t);if(n)return n.find(o=>o.key===i)}const w=[{name:"Rainbow",isMonotonic:!1,params:{type:"cosine",a:[.5,.5,.5],b:[.5,.5,.5],c:[1,1,1],d:[0,.33,.67]}},{name:"Fire",isMonotonic:!1,params:{type:"cosine",a:[.5,.5,.5],b:[.5,.5,.5],c:[1,1,.5],d:[0,.1,.2]}},{name:"Ice",isMonotonic:!1,params:{type:"cosine",a:[.5,.5,.5],b:[.5,.5,.5],c:[1,.7,.4],d:[0,.15,.2]}},{name:"Sunset",isMonotonic:!1,params:{type:"cosine",a:[.5,.3,.2],b:[.5,.4,.3],c:[1,1,.5],d:[0,.1,.2]}},{name:"Electric",isMonotonic:!1,params:{type:"cosine",a:[.5,.5,.5],b:[.6,.6,.6],c:[1,1,1],d:[.3,.2,.2]}},{name:"Neon",isMonotonic:!1,params:{type:"cosine",a:[.5,.5,.5],b:[.5,.5,.5],c:[1,1,1],d:[0,.1,.2]}},{name:"Emerald",isMonotonic:!1,params:{type:"cosine",a:[.2,.5,.3],b:[.3,.5,.3],c:[1,1,1],d:[0,.25,.5]}},{name:"Candy",isMonotonic:!1,params:{type:"cosine",a:[.8,.5,.5],b:[.2,.4,.4],c:[1,1,2],d:[0,.25,.25]}},{name:"Plasma",isMonotonic:!1,params:{type:"cosine",a:[.5,.5,.5],b:[.5,.5,.5],c:[2,1,0],d:[.5,.2,.25]}},{name:"Peacock",isMonotonic:!1,params:{type:"cosine",a:[.3,.5,.5],b:[.4,.4,.3],c:[1,1,1],d:[0,.1,.35]}},{name:"Autumn",isMonotonic:!1,params:{type:"cosine",a:[.6,.4,.2],b:[.4,.3,.2],c:[1,1,1],d:[0,.05,.1]}},{name:"Aurora",isMonotonic:!1,params:{type:"cosine",a:[.3,.5,.5],b:[.5,.5,.5],c:[1,1,.5],d:[.8,.9,.3]}}],k=[{name:"Blue",isMonotonic:!0,params:{type:"gradient",c1:[.02,.01,.08],c2:[.05,.15,.25],c3:[.1,.4,.5],c4:[.3,.6,.8],c5:[.7,.9,1]},hdrParams:{type:"gradient",c1:[.2,.4,1],c2:[.3,.6,1],c3:[.4,.8,1],c4:[.6,.9,1],c5:[.85,1,1]}},{name:"Gold",isMonotonic:!0,params:{type:"gradient",c1:[.04,.02,.01],c2:[.2,.08,.02],c3:[.5,.25,.05],c4:[.85,.6,.2],c5:[1,.95,.7]},hdrParams:{type:"gradient",c1:[1,.5,.1],c2:[1,.65,.2],c3:[1,.8,.3],c4:[1,.9,.5],c5:[1,1,.8]}},{name:"Grayscale",isMonotonic:!0,params:{type:"gradient",c1:[.01,.01,.03],c2:[.15,.15,.17],c3:[.45,.45,.45],c4:[.75,.74,.72],c5:[1,.98,.95]},hdrParams:{type:"gradient",c1:[1,1,1],c2:[1,1,1],c3:[1,1,1],c4:[1,1,1],c5:[1,1,1]}},{name:"Sepia",isMonotonic:!0,params:{type:"gradient",c1:[.03,.02,.01],c2:[.15,.08,.03],c3:[.4,.25,.12],c4:[.7,.55,.35],c5:[1,.95,.85]},hdrParams:{type:"gradient",c1:[1,.7,.4],c2:[1,.8,.55],c3:[1,.88,.7],c4:[1,.95,.85],c5:[1,1,.95]}},{name:"Ocean",isMonotonic:!0,params:{type:"gradient",c1:[0,.02,.05],c2:[.02,.08,.2],c3:[.05,.3,.4],c4:[.2,.6,.6],c5:[.6,.95,.9]},hdrParams:{type:"gradient",c1:[.1,.8,.8],c2:[.2,.9,.85],c3:[.4,.95,.9],c4:[.65,1,.95],c5:[.85,1,1]}},{name:"Purple",isMonotonic:!0,params:{type:"gradient",c1:[.03,.01,.06],c2:[.15,.05,.25],c3:[.4,.15,.5],c4:[.7,.4,.75],c5:[.95,.8,1]},hdrParams:{type:"gradient",c1:[.8,.2,1],c2:[.85,.4,1],c3:[.9,.6,1],c4:[.95,.8,1],c5:[1,.95,1]}},{name:"Forest",isMonotonic:!0,params:{type:"gradient",c1:[.02,.03,.01],c2:[.05,.12,.04],c3:[.1,.35,.15],c4:[.3,.65,.3],c5:[.7,.95,.6]},hdrParams:{type:"gradient",c1:[.3,1,.2],c2:[.5,1,.4],c3:[.7,1,.55],c4:[.85,1,.75],c5:[.95,1,.9]}}],C=w.length,P=k.length;function ye(i){return w[i%C].params}function be(i,e){const t=k[i%P];return e&&t.hdrParams?t.hdrParams:t.params}function ve(i){return w[i%C]}function xe(i){return k[i%P]}function Ce(i){return w[i%C].name}function Pe(i){return k[i%P].name}const ze=`// WebGPU Shader for Mandelbrot Set with HDR support\r
...
//# sourceMappingURL=index-Cm9aXyTp.js.map
