var F=Object.defineProperty;var q=(i,e,t)=>e in i?F(i,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):i[e]=t;var s=(i,e,t)=>q(i,typeof e!="symbol"?e+"":e,t);(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))n(o);new MutationObserver(o=>{for(const r of o)if(r.type==="childList")for(const a of r.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&n(a)}).observe(document,{childList:!0,subtree:!0});function t(o){const r={};return o.integrity&&(r.integrity=o.integrity),o.referrerPolicy&&(r.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?r.credentials="include":o.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function n(o){if(o.ep)return;o.ep=!0;const r=t(o);fetch(o.href,r)}})();class P{constructor(e){s(this,"device");s(this,"context");s(this,"canvas");s(this,"format");s(this,"animationFrameId",null);s(this,"renderCallback",null);s(this,"hdrEnabled",!1);s(this,"_displaySupportsHDR",!1);s(this,"hdrMediaQuery",null);s(this,"onHdrChangeCallback",null);this.canvas=e,this._displaySupportsHDR=this.detectHDRDisplay(),this.setupHdrMediaQueryListener()}get displaySupportsHDR(){return this._displaySupportsHDR}static async create(e){const t=new P(e);return await t.initialize(),t}static isSupported(){return"gpu"in navigator}async initialize(){if(!navigator.gpu)throw new Error("WebGPU is not supported in this browser");console.log("WebGPU HDR capability check:"),console.log("  - Display supports HDR:",this.displaySupportsHDR),console.log("  - dynamic-range: high:",window.matchMedia?.("(dynamic-range: high)").matches),console.log("  - color-gamut: p3:",window.matchMedia?.("(color-gamut: p3)").matches);const e=await navigator.gpu.requestAdapter({powerPreference:"high-performance"});if(!e)throw new Error("Failed to get WebGPU adapter");if("info"in e){const t=e.info;console.log("  - Adapter:",t?.vendor,t?.architecture)}if(this.device=await e.requestDevice(),this.context=this.canvas.getContext("webgpu"),!this.context)throw new Error("Failed to get WebGPU context");this.configureContext(),console.log("WebGPU initialized successfully"),this.hdrEnabled&&console.log("HDR mode enabled with rgba16float + extended tone mapping")}configureContext(){const e=navigator.gpu.getPreferredCanvasFormat();if(this.displaySupportsHDR)try{this.format="rgba16float",this.context.configure({device:this.device,format:this.format,alphaMode:"opaque",toneMapping:{mode:"extended"}}),this.hdrEnabled=!0,console.log("  - Configured with rgba16float + extended tone mapping (HDR)")}catch(t){console.log("  - HDR configuration failed, falling back to SDR:",t),this.format=e,this.context.configure({device:this.device,format:this.format,alphaMode:"opaque"}),this.hdrEnabled=!1}else this.format=e,this.context.configure({device:this.device,format:this.format,alphaMode:"opaque"}),this.hdrEnabled=!1,console.log("  - Configured with",this.format,"(SDR)")}resize(e,t){const n=window.devicePixelRatio||1;this.canvas.width=e*n,this.canvas.height=t*n,this.canvas.style.width=`${e}px`,this.canvas.style.height=`${t}px`}getCurrentTexture(){return this.context.getCurrentTexture()}start(e){if(this.animationFrameId!==null)return;this.renderCallback=e;const t=()=>{this.renderCallback&&this.renderCallback(),this.animationFrameId=requestAnimationFrame(t)};this.animationFrameId=requestAnimationFrame(t)}stop(){this.animationFrameId!==null&&(cancelAnimationFrame(this.animationFrameId),this.animationFrameId=null),this.renderCallback=null}detectHDRDisplay(){return!!window.matchMedia?.("(dynamic-range: high)").matches}setupHdrMediaQueryListener(){if(!window.matchMedia)return;this.hdrMediaQuery=window.matchMedia("(dynamic-range: high)");const e=()=>{const t=this.detectHDRDisplay();t!==this._displaySupportsHDR&&(console.log(`HDR display support changed: ${this._displaySupportsHDR} -> ${t}`),this._displaySupportsHDR=t,this.context&&this.device&&this.configureContext(),this.onHdrChangeCallback?.())};this.hdrMediaQuery.addEventListener?.("change",e)}setOnHdrChange(e){this.onHdrChangeCallback=e}destroy(){this.stop(),this.onHdrChangeCallback=null,this.device?.destroy()}}class ${constructor(e=-.5,t=0,n=.4){s(this,"centerX");s(this,"centerY");s(this,"zoom");this.centerX=e,this.centerY=t,this.zoom=n}pan(e,t,n,o){const r=-e/(this.zoom*n),a=t/(this.zoom*o);this.centerX+=r,this.centerY+=a}zoomAt(e,t,n,o,r){const a=this.centerX+(e/o-.5)/this.zoom,c=this.centerY-(t/r-.5)/this.zoom;this.zoom*=n,this.zoom=Math.max(.1,Math.min(this.zoom,1e15));const d=this.centerX+(e/o-.5)/this.zoom,f=this.centerY-(t/r-.5)/this.zoom;this.centerX+=a-d,this.centerY+=c-f}toFractalCoords(e,t,n,o){const r=n/o,a=(e/n-.5)*r,c=t/o-.5,d=this.centerX+a/this.zoom,f=this.centerY-c/this.zoom;return[d,f]}toScreenCoords(e,t,n,o){const r=n/o,a=(e-this.centerX)*this.zoom,c=(t-this.centerY)*this.zoom,d=(a/r+.5)*n,f=(-c+.5)*o;return[d,f]}zoomToPoint(e,t,n,o,r){const[a,c]=this.toFractalCoords(e,t,o,r);this.centerX=a,this.centerY=c,this.zoom*=n,this.zoom=Math.max(.1,Math.min(this.zoom,1e15))}reset(){this.centerX=-.5,this.centerY=0,this.zoom=.4}}const V=.6;function w(i){return 1+(i-1)*V}class W{constructor(e,t,n){s(this,"canvas");s(this,"viewState");s(this,"onChange");s(this,"onIterationAdjust",null);s(this,"onIterationReset",null);s(this,"onCosinePaletteCycle",null);s(this,"onGradientPaletteCycle",null);s(this,"onColorOffset",null);s(this,"onColorOffsetReset",null);s(this,"onToggleAA",null);s(this,"onAdjustHdrBrightness",null);s(this,"onResetHdrBrightness",null);s(this,"onFractalCycle",null);s(this,"onToggleJuliaMode",null);s(this,"onJuliaPick",null);s(this,"onShare",null);s(this,"onLocationSelect",null);s(this,"onToggleHelp",null);s(this,"onToggleScreenshotMode",null);s(this,"isDragging",!1);s(this,"lastX",0);s(this,"lastY",0);s(this,"lastTouchDistance",0);s(this,"juliaPickerMode",!1);this.canvas=e,this.viewState=t,this.onChange=n,this.setupEventListeners()}setIterationAdjustCallback(e){this.onIterationAdjust=e}setIterationResetCallback(e){this.onIterationReset=e}setCosinePaletteCycleCallback(e){this.onCosinePaletteCycle=e}setGradientPaletteCycleCallback(e){this.onGradientPaletteCycle=e}setColorOffsetCallback(e){this.onColorOffset=e}setColorOffsetResetCallback(e){this.onColorOffsetReset=e}setToggleAACallback(e){this.onToggleAA=e}setToggleHDRCallback(e){}setAdjustHdrBrightnessCallback(e){this.onAdjustHdrBrightness=e}setResetHdrBrightnessCallback(e){this.onResetHdrBrightness=e}setFractalCycleCallback(e){this.onFractalCycle=e}setToggleJuliaModeCallback(e){this.onToggleJuliaMode=e}setJuliaPickCallback(e){this.onJuliaPick=e}setShareCallback(e){this.onShare=e}setLocationSelectCallback(e){this.onLocationSelect=e}setToggleHelpCallback(e){this.onToggleHelp=e}setToggleScreenshotModeCallback(e){this.onToggleScreenshotMode=e}setJuliaPickerMode(e){this.juliaPickerMode=e,this.canvas.style.cursor=e?"crosshair":"grab"}isJuliaPickerModeActive(){return this.juliaPickerMode}setupEventListeners(){this.canvas.addEventListener("mousedown",this.handleMouseDown.bind(this)),this.canvas.addEventListener("mousemove",this.handleMouseMove.bind(this)),this.canvas.addEventListener("mouseup",this.handleMouseUp.bind(this)),this.canvas.addEventListener("mouseleave",this.handleMouseUp.bind(this)),this.canvas.addEventListener("wheel",this.handleWheel.bind(this),{passive:!1}),this.canvas.addEventListener("dblclick",this.handleDoubleClick.bind(this)),this.canvas.addEventListener("touchstart",this.handleTouchStart.bind(this),{passive:!1}),this.canvas.addEventListener("touchmove",this.handleTouchMove.bind(this),{passive:!1}),this.canvas.addEventListener("touchend",this.handleTouchEnd.bind(this)),this.canvas.addEventListener("touchcancel",this.handleTouchEnd.bind(this)),this.canvas.addEventListener("contextmenu",e=>e.preventDefault()),window.addEventListener("keydown",this.handleKeyDown.bind(this))}getCanvasRect(){return this.canvas.getBoundingClientRect()}getScreenCoords(e,t){const n=this.getCanvasRect();return[e-n.left,t-n.top]}getCanvasSize(){const e=this.getCanvasRect();return[e.width,e.height]}notifyChange(){this.onChange(this.viewState)}handleMouseDown(e){if(e.button!==0)return;const[t,n]=this.getScreenCoords(e.clientX,e.clientY);if(this.juliaPickerMode&&this.onJuliaPick){const[o,r]=this.getCanvasSize(),[a,c]=this.viewState.toFractalCoords(t,n,o,r);this.onJuliaPick(a,c);return}this.isDragging=!0,this.lastX=t,this.lastY=n,this.canvas.style.cursor="grabbing"}handleMouseMove(e){if(!this.isDragging)return;const[t,n]=this.getScreenCoords(e.clientX,e.clientY),o=t-this.lastX,r=n-this.lastY,[a,c]=this.getCanvasSize();this.viewState.pan(o,r,a,c),this.notifyChange(),this.lastX=t,this.lastY=n}handleMouseUp(){this.isDragging&&(this.isDragging=!1,this.canvas.style.cursor="grab")}handleWheel(e){e.preventDefault();const[t,n]=this.getScreenCoords(e.clientX,e.clientY),o=e.deltaY>0?.9:1.1,r=w(o),[a,c]=this.getCanvasSize();this.viewState.zoomAt(t,n,r,a,c),this.notifyChange()}handleDoubleClick(e){const[t,n]=this.getScreenCoords(e.clientX,e.clientY),[o,r]=this.getCanvasSize();this.viewState.zoomToPoint(t,n,w(2),o,r),this.notifyChange()}getTouchDistance(e){if(e.length<2)return 0;const t=e[0].clientX-e[1].clientX,n=e[0].clientY-e[1].clientY;return Math.sqrt(t*t+n*n)}getTouchCenter(e){if(e.length===0)return[0,0];if(e.length===1)return this.getScreenCoords(e[0].clientX,e[0].clientY);const t=(e[0].clientX+e[1].clientX)/2,n=(e[0].clientY+e[1].clientY)/2;return this.getScreenCoords(t,n)}handleTouchStart(e){if(e.touches.length===1){this.isDragging=!0;const[t,n]=this.getScreenCoords(e.touches[0].clientX,e.touches[0].clientY);this.lastX=t,this.lastY=n}else e.touches.length===2&&(this.isDragging=!1,this.lastTouchDistance=this.getTouchDistance(e.touches))}handleTouchMove(e){if(e.preventDefault(),e.touches.length===1&&this.isDragging){const[t,n]=this.getScreenCoords(e.touches[0].clientX,e.touches[0].clientY),o=t-this.lastX,r=n-this.lastY,[a,c]=this.getCanvasSize();this.viewState.pan(o,r,a,c),this.notifyChange(),this.lastX=t,this.lastY=n}else if(e.touches.length===2){const t=this.getTouchDistance(e.touches),n=this.getTouchCenter(e.touches);if(this.lastTouchDistance>0){const o=t/this.lastTouchDistance,r=w(o),[a,c]=this.getCanvasSize();this.viewState.zoomAt(n[0],n[1],r,a,c),this.notifyChange()}this.lastTouchDistance=t}}handleTouchEnd(){this.isDragging=!1,this.lastTouchDistance=0}handleKeyDown(e){if(!(e.target instanceof HTMLInputElement||e.target instanceof HTMLTextAreaElement))switch(e.key){case"+":case"=":e.preventDefault(),this.onIterationAdjust?.(1);break;case"-":case"_":e.preventDefault(),this.onIterationAdjust?.(-1);break;case"0":e.preventDefault(),this.onIterationReset?.();break;case"c":e.preventDefault(),this.onCosinePaletteCycle?.(1);break;case"C":e.preventDefault(),this.onCosinePaletteCycle?.(-1);break;case"g":e.preventDefault(),this.onGradientPaletteCycle?.(1);break;case"G":e.preventDefault(),this.onGradientPaletteCycle?.(-1);break;case"[":case",":e.preventDefault(),this.onColorOffset?.(-.05);break;case"]":case".":e.preventDefault(),this.onColorOffset?.(.05);break;case"{":case"<":e.preventDefault(),this.onColorOffset?.(-.15);break;case"}":case">":e.preventDefault(),this.onColorOffset?.(.15);break;case"r":case"R":e.preventDefault(),this.onColorOffsetReset?.();break;case"a":case"A":e.preventDefault(),this.onToggleAA?.();break;case"b":e.preventDefault(),this.onAdjustHdrBrightness?.(1);break;case"B":e.preventDefault(),this.onAdjustHdrBrightness?.(-1);break;case"d":e.preventDefault(),this.onResetHdrBrightness?.();break;case"f":e.preventDefault(),this.onFractalCycle?.(1);break;case"F":e.preventDefault(),this.onFractalCycle?.(-1);break;case"j":case"J":e.preventDefault(),this.onToggleJuliaMode?.();break;case"s":case"S":e.preventDefault(),this.onShare?.();break;case"1":case"2":case"3":case"4":case"5":case"6":case"7":case"8":case"9":e.preventDefault(),this.onLocationSelect?.(e.key);break;case"h":case"H":e.preventDefault(),this.onToggleHelp?.();break;case" ":e.preventDefault(),this.onToggleScreenshotMode?.();break}}destroy(){}}var p=(i=>(i[i.Mandelbrot=0]="Mandelbrot",i[i.MandelbrotJulia=1]="MandelbrotJulia",i[i.BurningShip=2]="BurningShip",i[i.BurningShipJulia=3]="BurningShipJulia",i[i.Tricorn=4]="Tricorn",i[i.TricornJulia=5]="TricornJulia",i[i.Celtic=6]="Celtic",i[i.CelticJulia=7]="CelticJulia",i[i.Buffalo=8]="Buffalo",i[i.BuffaloJulia=9]="BuffaloJulia",i[i.Phoenix=10]="Phoenix",i[i.PhoenixJulia=11]="PhoenixJulia",i[i.Multibrot3=12]="Multibrot3",i[i.Multibrot3Julia=13]="Multibrot3Julia",i[i.Multibrot4=14]="Multibrot4",i[i.Multibrot4Julia=15]="Multibrot4Julia",i[i.Funky=16]="Funky",i[i.FunkyJulia=17]="FunkyJulia",i[i.Perpendicular=18]="Perpendicular",i[i.PerpendicularJulia=19]="PerpendicularJulia",i))(p||{});const Z={0:"Mandelbrot",1:"Mandelbrot Julia",2:"Burning Ship",3:"Burning Ship Julia",4:"Tricorn",5:"Tricorn Julia",6:"Celtic",7:"Celtic Julia",8:"Buffalo",9:"Buffalo Julia",10:"Phoenix",11:"Phoenix Julia",12:"Multibrot (z³)",13:"Multibrot³ Julia",14:"Multibrot (z⁴)",15:"Multibrot⁴ Julia",16:"Funky",17:"Funky Julia",18:"Perpendicular",19:"Perpendicular Julia"},D=10;function T(i){return(i&1)===1}function H(i){return i&-2}function K(i){return i|1}const h={TYPE:"t",CENTER_X:"x",CENTER_Y:"y",ZOOM:"z",PALETTE:"p",PALETTE_TYPE:"pt",COSINE_PALETTE:"cp",GRADIENT_PALETTE:"gp",COLOR_OFFSET:"o",JULIA_REAL:"jr",JULIA_IMAG:"ji",ITERATIONS:"i",AA:"aa"};function v(i,e=15){return i===0?"0":Math.abs(i)<1e-10||Math.abs(i)>1e10?i.toExponential(e):parseFloat(i.toPrecision(e)).toString()}function u(i){if(i===null||i==="")return null;const e=parseFloat(i);return isNaN(e)?null:e}function N(i){const e=new URLSearchParams;return e.set(h.TYPE,i.fractalType.toString()),e.set(h.CENTER_X,v(i.centerX)),e.set(h.CENTER_Y,v(i.centerY)),e.set(h.ZOOM,v(i.zoom)),e.set(h.PALETTE_TYPE,i.paletteType==="cosine"?"c":"g"),e.set(h.COSINE_PALETTE,i.cosinePaletteIndex.toString()),e.set(h.GRADIENT_PALETTE,i.gradientPaletteIndex.toString()),Math.abs(i.colorOffset)>.001&&e.set(h.COLOR_OFFSET,v(i.colorOffset,4)),T(i.fractalType)&&(e.set(h.JULIA_REAL,v(i.juliaC[0])),e.set(h.JULIA_IMAG,v(i.juliaC[1]))),i.maxIterationsOverride!==null&&e.set(h.ITERATIONS,i.maxIterationsOverride.toString()),i.aaEnabled&&e.set(h.AA,"1"),e.toString()}function Q(i){const e=new URLSearchParams(i.replace(/^#/,"")),t={},n=u(e.get(h.TYPE));n!==null&&n>=0&&n<=19&&(t.fractalType=n);const o=u(e.get(h.CENTER_X));o!==null&&(t.centerX=o);const r=u(e.get(h.CENTER_Y));r!==null&&(t.centerY=r);const a=u(e.get(h.ZOOM));a!==null&&a>0&&(t.zoom=a);const c=e.get(h.PALETTE_TYPE);(c==="c"||c==="g")&&(t.paletteType=c==="c"?"cosine":"gradient");const d=u(e.get(h.COSINE_PALETTE));d!==null&&d>=0&&(t.cosinePaletteIndex=Math.floor(d));const f=u(e.get(h.GRADIENT_PALETTE));f!==null&&f>=0&&(t.gradientPaletteIndex=Math.floor(f));const l=u(e.get(h.PALETTE));l!==null&&l>=0&&l<=11&&(t.paletteIndex=Math.floor(l));const z=u(e.get(h.COLOR_OFFSET));z!==null&&(t.colorOffset=z);const C=u(e.get(h.JULIA_REAL)),m=u(e.get(h.JULIA_IMAG));C!==null&&m!==null&&(t.juliaC=[C,m]);const g=u(e.get(h.ITERATIONS));return g!==null&&g>0&&(t.maxIterationsOverride=Math.floor(g)),e.get(h.AA)==="1"&&(t.aaEnabled=!0),t}function ee(i){const e=N(i),t=new URL(window.location.href);return t.hash=e,t.toString()}function te(i){const e=N(i);window.history.replaceState(null,"","#"+e)}function ie(){return Q(window.location.hash)}async function ne(i){const e=ee(i);try{return await navigator.clipboard.writeText(e),!0}catch{const t=document.createElement("textarea");t.value=e,t.style.position="fixed",t.style.left="-9999px",document.body.appendChild(t),t.select();try{return document.execCommand("copy"),!0}catch{return!1}finally{document.body.removeChild(t)}}}const ae=[{name:"Seahorse Valley",description:"The iconic seahorse-shaped spirals in the Mandelbrot set",key:"1",state:{fractalType:p.Mandelbrot,centerX:-.747,centerY:.1,zoom:70,paletteType:"cosine",cosinePaletteIndex:1,gradientPaletteIndex:0,colorOffset:.1,juliaC:[-.7,.27015],maxIterationsOverride:null,aaEnabled:!1}},{name:"Elephant Valley",description:"Elephant trunk-like spirals on the positive real side",key:"2",state:{fractalType:p.Mandelbrot,centerX:.273897508880652,centerY:.00596002252770864,zoom:180,paletteType:"cosine",cosinePaletteIndex:3,gradientPaletteIndex:0,colorOffset:-.1,juliaC:[.273897508880652,.00596002252770864],maxIterationsOverride:null,aaEnabled:!1}},{name:"Double Spiral Valley",description:"Beautiful double spirals deep in the set",key:"3",state:{fractalType:p.Mandelbrot,centerX:-.743733589978665,centerY:.130905227502858,zoom:350,paletteType:"cosine",cosinePaletteIndex:4,gradientPaletteIndex:0,colorOffset:.2,juliaC:[-.7,.27015],maxIterationsOverride:null,aaEnabled:!1}},{name:"Spiral Galaxy",description:"Galactic spiral arms emerging from chaos",key:"4",state:{fractalType:p.Mandelbrot,centerX:-.761542947469557,centerY:-.0848063048239542,zoom:1300,paletteType:"cosine",cosinePaletteIndex:2,gradientPaletteIndex:0,colorOffset:-.6,juliaC:[-.7,.27015],maxIterationsOverride:null,aaEnabled:!1}},{name:"The Armada",description:"Mini ships along the antenna of the Burning Ship fractal",key:"5",state:{fractalType:p.BurningShip,centerX:-1.80173025652805,centerY:.0153452534367207,zoom:9,paletteType:"cosine",cosinePaletteIndex:4,gradientPaletteIndex:0,colorOffset:.2,juliaC:[-.7,.27015],maxIterationsOverride:null,aaEnabled:!1}},{name:"Douady Rabbit",description:"The famous rabbit-eared Julia set",key:"6",state:{fractalType:p.MandelbrotJulia,centerX:0,centerY:0,zoom:.6,paletteType:"cosine",cosinePaletteIndex:4,gradientPaletteIndex:0,colorOffset:.2,juliaC:[-.123,.745],maxIterationsOverride:null,aaEnabled:!1}},{name:"Dragon Julia",description:"Fierce dragon-like Julia set",key:"7",state:{fractalType:p.MandelbrotJulia,centerX:0,centerY:0,zoom:.45,paletteType:"cosine",cosinePaletteIndex:3,gradientPaletteIndex:0,colorOffset:.5,juliaC:[-.8,.156],maxIterationsOverride:null,aaEnabled:!1}},{name:"Lightning Julia",description:"Electric, lightning-like patterns",key:"8",state:{fractalType:p.MandelbrotJulia,centerX:0,centerY:0,zoom:.45,paletteType:"cosine",cosinePaletteIndex:4,gradientPaletteIndex:0,colorOffset:.2,juliaC:[-.7269,.1889],maxIterationsOverride:1e3,aaEnabled:!1}},{name:"Phoenix Julia",description:"The classic Phoenix fractal with feathery tendrils",key:"9",state:{fractalType:p.PhoenixJulia,centerX:0,centerY:0,zoom:.5,paletteType:"cosine",cosinePaletteIndex:1,gradientPaletteIndex:0,colorOffset:.2,juliaC:[.5667,-.5],maxIterationsOverride:null,aaEnabled:!1}}];function se(i){return ae.find(e=>e.key===i)}const M=[{name:"Rainbow",isMonotonic:!1,params:{type:"cosine",a:[.5,.5,.5],b:[.5,.5,.5],c:[1,1,1],d:[0,.33,.67]}},{name:"Fire",isMonotonic:!1,params:{type:"cosine",a:[.5,.5,.5],b:[.5,.5,.5],c:[1,1,.5],d:[0,.1,.2]}},{name:"Ice",isMonotonic:!1,params:{type:"cosine",a:[.5,.5,.5],b:[.5,.5,.5],c:[1,.7,.4],d:[0,.15,.2]}},{name:"Sunset",isMonotonic:!1,params:{type:"cosine",a:[.5,.3,.2],b:[.5,.4,.3],c:[1,1,.5],d:[0,.1,.2]}},{name:"Electric",isMonotonic:!1,params:{type:"cosine",a:[.5,.5,.5],b:[.6,.6,.6],c:[1,1,1],d:[.3,.2,.2]}},{name:"Neon",isMonotonic:!1,params:{type:"cosine",a:[.5,.5,.5],b:[.5,.5,.5],c:[1,1,1],d:[0,.1,.2]}},{name:"Emerald",isMonotonic:!1,params:{type:"cosine",a:[.2,.5,.3],b:[.3,.5,.3],c:[1,1,1],d:[0,.25,.5]}},{name:"Candy",isMonotonic:!1,params:{type:"cosine",a:[.8,.5,.5],b:[.2,.4,.4],c:[1,1,2],d:[0,.25,.25]}},{name:"Plasma",isMonotonic:!1,params:{type:"cosine",a:[.5,.5,.5],b:[.5,.5,.5],c:[2,1,0],d:[.5,.2,.25]}},{name:"Peacock",isMonotonic:!1,params:{type:"cosine",a:[.3,.5,.5],b:[.4,.4,.3],c:[1,1,1],d:[0,.1,.35]}},{name:"Autumn",isMonotonic:!1,params:{type:"cosine",a:[.6,.4,.2],b:[.4,.3,.2],c:[1,1,1],d:[0,.05,.1]}},{name:"Aurora",isMonotonic:!1,params:{type:"cosine",a:[.3,.5,.5],b:[.5,.5,.5],c:[1,1,.5],d:[.8,.9,.3]}}],I=[{name:"Blue",isMonotonic:!0,params:{type:"gradient",c1:[.02,.01,.08],c2:[.05,.15,.25],c3:[.1,.4,.5],c4:[.3,.6,.8],c5:[.7,.9,1]},hdrParams:{type:"gradient",c1:[.2,.4,1],c2:[.3,.6,1],c3:[.4,.8,1],c4:[.6,.9,1],c5:[.85,1,1]}},{name:"Gold",isMonotonic:!0,params:{type:"gradient",c1:[.04,.02,.01],c2:[.2,.08,.02],c3:[.5,.25,.05],c4:[.85,.6,.2],c5:[1,.95,.7]},hdrParams:{type:"gradient",c1:[1,.5,.1],c2:[1,.65,.2],c3:[1,.8,.3],c4:[1,.9,.5],c5:[1,1,.8]}},{name:"Grayscale",isMonotonic:!0,params:{type:"gradient",c1:[.01,.01,.03],c2:[.15,.15,.17],c3:[.45,.45,.45],c4:[.75,.74,.72],c5:[1,.98,.95]},hdrParams:{type:"gradient",c1:[1,1,1],c2:[1,1,1],c3:[1,1,1],c4:[1,1,1],c5:[1,1,1]}},{name:"Sepia",isMonotonic:!0,params:{type:"gradient",c1:[.03,.02,.01],c2:[.15,.08,.03],c3:[.4,.25,.12],c4:[.7,.55,.35],c5:[1,.95,.85]},hdrParams:{type:"gradient",c1:[1,.7,.4],c2:[1,.8,.55],c3:[1,.88,.7],c4:[1,.95,.85],c5:[1,1,.95]}},{name:"Ocean",isMonotonic:!0,params:{type:"gradient",c1:[0,.02,.05],c2:[.02,.08,.2],c3:[.05,.3,.4],c4:[.2,.6,.6],c5:[.6,.95,.9]},hdrParams:{type:"gradient",c1:[.1,.8,.8],c2:[.2,.9,.85],c3:[.4,.95,.9],c4:[.65,1,.95],c5:[.85,1,1]}},{name:"Purple",isMonotonic:!0,params:{type:"gradient",c1:[.03,.01,.06],c2:[.15,.05,.25],c3:[.4,.15,.5],c4:[.7,.4,.75],c5:[.95,.8,1]},hdrParams:{type:"gradient",c1:[.8,.2,1],c2:[.85,.4,1],c3:[.9,.6,1],c4:[.95,.8,1],c5:[1,.95,1]}},{name:"Forest",isMonotonic:!0,params:{type:"gradient",c1:[.02,.03,.01],c2:[.05,.12,.04],c3:[.1,.35,.15],c4:[.3,.65,.3],c5:[.7,.95,.6]},hdrParams:{type:"gradient",c1:[.3,1,.2],c2:[.5,1,.4],c3:[.7,1,.55],c4:[.85,1,.75],c5:[.95,1,.9]}}],b=M.length,x=I.length;function oe(i){return M[i%b].params}function re(i,e){const t=I[i%x];return e&&t.hdrParams?t.hdrParams:t.params}function le(i){return M[i%b]}function ce(i){return I[i%x]}function he(i){return M[i%b].name}function de(i){return I[i%x].name}const fe=`// WebGPU Shader for Mandelbrot Set with HDR support
...
`,ue=256,pe=512,ge=4096,me=640,ye=1.65,B=1.5;function L(i,e=!1){const t=Math.max(1,i),n=Math.log10(t),o=e?pe:ue,r=o+me*Math.pow(n,ye);return Math.round(Math.max(o,Math.min(ge,r)))}const _=256;class k{constructor(e,t){s(this,"renderer");s(this,"viewState");s(this,"inputHandler");s(this,"pipeline");s(this,"uniformBuffer");s(this,"bindGroup");s(this,"maxIterationsOverride",null);s(this,"fractalType",p.Mandelbrot);s(this,"juliaC",[-.7,.27015]);s(this,"juliaPickerMode",!1);s(this,"savedViewState",null);s(this,"savedFractalType",null);s(this,"paletteType","cosine");s(this,"cosinePaletteIndex",1);s(this,"gradientPaletteIndex",0);s(this,"colorOffset",0);s(this,"hdrBrightnessBias",0);s(this,"sdrGradientBrightness",1);s(this,"debugOverlay",null);s(this,"shareNotification",null);s(this,"helpOverlay",null);s(this,"helpVisible",!1);s(this,"screenshotMode",!1);s(this,"handleResize",()=>{this.renderer.resize(window.innerWidth,window.innerHeight),this.render()});s(this,"handleHashChange",()=>{this.loadBookmark()});this.renderer=e,this.viewState=new $,this.inputHandler=new W(t,this.viewState,()=>{this.render()}),this.setupInputCallbacks(),this.setupOverlays(t)}static async create(e){const t=await P.create(e),n=new k(t,e);return await n.initializePipeline(),t.setOnHdrChange(()=>{console.log("HDR status changed, re-rendering..."),n.render()}),window.addEventListener("resize",n.handleResize),window.addEventListener("hashchange",n.handleHashChange),n.loadBookmark(),n.handleResize(),n}async initializePipeline(){const e=this.renderer.device,t=e.createShaderModule({label:"Mandelbrot Shader",code:fe});this.uniformBuffer=e.createBuffer({label:"Uniforms",size:_,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST});const n=e.createBindGroupLayout({label:"Bind Group Layout",entries:[{binding:0,visibility:GPUShaderStage.VERTEX|GPUShaderStage.FRAGMENT,buffer:{type:"uniform"}}]});this.bindGroup=e.createBindGroup({label:"Bind Group",layout:n,entries:[{binding:0,resource:{buffer:this.uniformBuffer}}]});const o=e.createPipelineLayout({label:"Pipeline Layout",bindGroupLayouts:[n]});this.pipeline=e.createRenderPipeline({label:"Mandelbrot Pipeline",layout:o,vertex:{module:t,entryPoint:"vertexMain"},fragment:{module:t,entryPoint:"fragmentMain",targets:[{format:this.renderer.format}]},primitive:{topology:"triangle-list"}}),console.log("WebGPU pipeline initialized")}setupInputCallbacks(){this.inputHandler.setIterationAdjustCallback(e=>{this.adjustMaxIterations(e)}),this.inputHandler.setIterationResetCallback(()=>{this.clearMaxIterationsOverride()}),this.inputHandler.setCosinePaletteCycleCallback(e=>{this.cycleCosinePalette(e)}),this.inputHandler.setGradientPaletteCycleCallback(e=>{this.cycleGradientPalette(e)}),this.inputHandler.setColorOffsetCallback(e=>{this.adjustColorOffset(e)}),this.inputHandler.setColorOffsetResetCallback(()=>{this.resetColorOffset()}),this.inputHandler.setToggleAACallback(()=>{console.log("AA not available in WebGPU HDR mode")}),this.inputHandler.setToggleHDRCallback(()=>{this.toggleHDR()}),this.inputHandler.setAdjustHdrBrightnessCallback(e=>{this.adjustHdrBrightness(e)}),this.inputHandler.setResetHdrBrightnessCallback(()=>{this.resetHdrBrightness()}),this.inputHandler.setFractalCycleCallback(e=>{this.cycleFractalType(e)}),this.inputHandler.setToggleJuliaModeCallback(()=>{this.toggleJuliaPickerMode()}),this.inputHandler.setJuliaPickCallback((e,t)=>{this.pickJuliaConstant(e,t)}),this.inputHandler.setShareCallback(()=>{this.shareBookmark()}),this.inputHandler.setLocationSelectCallback(e=>{this.goToLocation(e)}),this.inputHandler.setToggleHelpCallback(()=>{this.toggleHelp()}),this.inputHandler.setToggleScreenshotModeCallback(()=>{this.toggleScreenshotMode()})}setupOverlays(e){const t=e.parentElement;t&&(this.debugOverlay=document.createElement("div"),this.debugOverlay.id="zoom-debug",t.appendChild(this.debugOverlay),this.shareNotification=document.createElement("div"),this.shareNotification.id="share-notification",this.shareNotification.style.cssText=`
    ...
    `,t.appendChild(this.helpOverlay))}render(){const e=this.renderer.device,t=this.renderer.canvas,n=T(this.fractalType),o=this.maxIterationsOverride??L(this.viewState.zoom,n);if(this.debugOverlay&&!this.screenshotMode){const g=this.viewState.zoom,G=g>=1e6?g.toExponential(2):g<1?g.toPrecision(4):String(Math.round(g)),j=this.maxIterationsOverride!==null?" (manual)":"",Y=this.paletteType==="cosine"?he(this.cosinePaletteIndex):de(this.gradientPaletteIndex),X=Z[this.fractalType],U=this.renderer.hdrEnabled?Math.abs(this.hdrBrightnessBias)>.01?`HDR (${this.hdrBrightnessBias>0?"+":""}${this.hdrBrightnessBias.toFixed(2)})`:"HDR":this.renderer.displaySupportsHDR?"HDR available":"SDR",E=!this.renderer.hdrEnabled&&this.paletteType==="gradient"&&Math.abs(this.sdrGradientBrightness-1)>.01?`brightness ${this.sdrGradientBrightness.toFixed(1)}`:"",O=this.juliaPickerMode?"🎯 Pick Julia point":"",R=n?`c=(${this.juliaC[0].toFixed(4)}, ${this.juliaC[1].toFixed(4)})`:"",A=Math.abs(this.colorOffset)>.001?`offset ${this.colorOffset.toFixed(1)}`:"",y=[X,`zoom ${G}`,`iterations ${o}${j}`,Y];A&&y.push(A),E&&y.push(E),R&&y.push(R),y.push(U),O&&y.push(O),y.push("H = help"),this.debugOverlay.textContent=y.join("  ·  ")}const r=new ArrayBuffer(_),a=new Float32Array(r),c=new Int32Array(r),d=this.paletteType==="cosine",f=d?le(this.cosinePaletteIndex):ce(this.gradientPaletteIndex),l=d?oe(this.cosinePaletteIndex):re(this.gradientPaletteIndex,this.renderer.hdrEnabled);a[0]=t.width,a[1]=t.height,a[2]=this.viewState.centerX,a[3]=this.viewState.centerY,a[4]=this.viewState.zoom,c[5]=o,a[6]=performance.now()*.001,a[7]=this.colorOffset,c[8]=this.fractalType,a[10]=this.juliaC[0],a[11]=this.juliaC[1],c[12]=this.renderer.hdrEnabled?1:0,a[13]=this.hdrBrightnessBias,c[14]=l.type==="cosine"?0:1,c[15]=f.isMonotonic?1:0,a[16]=this.sdrGradientBrightness,l.type==="cosine"&&(a[20]=l.a[0],a[21]=l.a[1],a[22]=l.a[2],a[24]=l.b[0],a[25]=l.b[1],a[26]=l.b[2],a[28]=l.c[0],a[29]=l.c[1],a[30]=l.c[2],a[32]=l.d[0],a[33]=l.d[1],a[34]=l.d[2]),l.type==="gradient"&&(a[36]=l.c1[0],a[37]=l.c1[1],a[38]=l.c1[2],a[40]=l.c2[0],a[41]=l.c2[1],a[42]=l.c2[2],a[44]=l.c3[0],a[45]=l.c3[1],a[46]=l.c3[2],a[48]=l.c4[0],a[49]=l.c4[1],a[50]=l.c4[2],a[52]=l.c5[0],a[53]=l.c5[1],a[54]=l.c5[2]),e.queue.writeBuffer(this.uniformBuffer,0,r);const z=e.createCommandEncoder(),C=this.renderer.getCurrentTexture().createView(),m=z.beginRenderPass({colorAttachments:[{view:C,clearValue:{r:0,g:0,b:0,a:1},loadOp:"clear",storeOp:"store"}]});m.setPipeline(this.pipeline),m.setBindGroup(0,this.bindGroup),m.draw(3),m.end(),e.queue.submit([z.finish()])}start(){this.renderer.start(()=>this.render())}stop(){this.renderer.stop()}adjustMaxIterations(e){const t=T(this.fractalType),n=this.maxIterationsOverride??L(this.viewState.zoom,t),o=e>0?n*B:n/B;this.maxIterationsOverride=Math.round(Math.max(1,o)),this.render()}clearMaxIterationsOverride(){this.maxIterationsOverride=null,this.render()}toggleHDR(){console.log(`HDR is ${this.renderer.hdrEnabled?"enabled":"not available"}`),this.render()}adjustHdrBrightness(e){this.renderer.hdrEnabled?this.hdrBrightnessBias=Math.max(-1,Math.min(1,this.hdrBrightnessBias+e*.1)):this.paletteType==="gradient"&&(this.sdrGradientBrightness=Math.max(.1,Math.min(10,this.sdrGradientBrightness+e*.2))),this.render()}resetHdrBrightness(){this.hdrBrightnessBias=0,this.sdrGradientBrightness=1,this.render()}cycleCosinePalette(e){this.cosinePaletteIndex=(this.cosinePaletteIndex+e+b)%b,this.paletteType="cosine",this.render()}cycleGradientPalette(e){this.gradientPaletteIndex=(this.gradientPaletteIndex+e+x)%x,this.paletteType="gradient",this.render()}adjustColorOffset(e){this.colorOffset+=e,this.render()}resetColorOffset(){this.colorOffset=0,this.render()}cycleFractalType(e=1){const o=((H(this.fractalType)>>1)+e+D)%D;this.fractalType=o<<1,this.juliaPickerMode&&(this.juliaPickerMode=!1,this.inputHandler.setJuliaPickerMode(!1)),this.render()}toggleJuliaPickerMode(){if(T(this.fractalType)){this.exitJuliaMode();return}this.juliaPickerMode=!this.juliaPickerMode,this.inputHandler.setJuliaPickerMode(this.juliaPickerMode),this.render()}pickJuliaConstant(e,t){this.juliaPickerMode&&(this.savedViewState={centerX:this.viewState.centerX,centerY:this.viewState.centerY,zoom:this.viewState.zoom},this.savedFractalType=this.fractalType,this.juliaC=[e,t],this.fractalType=K(this.fractalType),this.viewState.centerX=0,this.viewState.centerY=0,this.viewState.zoom=.5,this.juliaPickerMode=!1,this.inputHandler.setJuliaPickerMode(!1),this.render())}exitJuliaMode(){this.savedViewState&&(this.viewState.centerX=this.savedViewState.centerX,this.viewState.centerY=this.savedViewState.centerY,this.viewState.zoom=this.savedViewState.zoom,this.savedViewState=null),this.savedFractalType!==null?(this.fractalType=this.savedFractalType,this.savedFractalType=null):this.fractalType=H(this.fractalType),this.juliaPickerMode=!1,this.inputHandler.setJuliaPickerMode(!1),this.render()}getBookmarkState(){return{fractalType:this.fractalType,centerX:this.viewState.centerX,centerY:this.viewState.centerY,zoom:this.viewState.zoom,paletteType:this.paletteType,cosinePaletteIndex:this.cosinePaletteIndex,gradientPaletteIndex:this.gradientPaletteIndex,colorOffset:this.colorOffset,juliaC:this.juliaC,maxIterationsOverride:this.maxIterationsOverride,aaEnabled:!1}}loadBookmark(){const e=ie();if(e){if(e.centerX!==void 0&&(this.viewState.centerX=e.centerX),e.centerY!==void 0&&(this.viewState.centerY=e.centerY),e.zoom!==void 0&&(this.viewState.zoom=e.zoom),e.maxIterationsOverride!==void 0&&(this.maxIterationsOverride=e.maxIterationsOverride),e.paletteType!==void 0&&(this.paletteType=e.paletteType),e.cosinePaletteIndex!==void 0&&(this.cosinePaletteIndex=e.cosinePaletteIndex%b),e.gradientPaletteIndex!==void 0&&(this.gradientPaletteIndex=e.gradientPaletteIndex%x),e.paletteIndex!==void 0&&e.paletteType===void 0){const t=[0,4,5,10,11];if(t.includes(e.paletteIndex))this.paletteType="cosine",this.cosinePaletteIndex=t.indexOf(e.paletteIndex);else{this.paletteType="gradient";const n=[1,2,3,6,7,8,9];this.gradientPaletteIndex=n.indexOf(e.paletteIndex)}}e.colorOffset!==void 0&&(this.colorOffset=e.colorOffset),e.fractalType!==void 0&&(this.fractalType=e.fractalType),e.juliaC!==void 0&&(this.juliaC=e.juliaC),this.render()}}goToLocation(e){const t=se(e);if(!t)return;const n=t.state;this.viewState.centerX=n.centerX,this.viewState.centerY=n.centerY,this.viewState.zoom=n.zoom,this.maxIterationsOverride=n.maxIterationsOverride,this.fractalType=n.fractalType,this.juliaC=n.juliaC,this.paletteType=n.paletteType,this.cosinePaletteIndex=n.cosinePaletteIndex,this.gradientPaletteIndex=n.gradientPaletteIndex,this.colorOffset=n.colorOffset,this.showLocationNotification(t.name,t.description),this.updateUrlBookmark(),this.render()}showLocationNotification(e,t){this.shareNotification&&(this.shareNotification.innerHTML=`<strong style="font-size: 18px;">📍 ${e}</strong><br><span style="color: #aaa; font-size: 14px;">${t}</span>`,this.shareNotification.style.color="#60a5fa",this.shareNotification.style.opacity="1",setTimeout(()=>{this.shareNotification&&(this.shareNotification.style.opacity="0")},2500))}updateUrlBookmark(){te(this.getBookmarkState())}async shareBookmark(){const e=await ne(this.getBookmarkState());this.showShareNotification(e),e&&this.updateUrlBookmark()}showShareNotification(e){this.shareNotification&&(this.shareNotification.textContent=e?"📋 Link copied to clipboard!":"❌ Failed to copy link",this.shareNotification.style.color=e?"#4ade80":"#f87171",this.shareNotification.style.opacity="1",setTimeout(()=>{this.shareNotification&&(this.shareNotification.style.opacity="0")},2e3))}toggleHelp(){this.helpVisible=!this.helpVisible,this.helpOverlay&&(this.helpOverlay.style.opacity=this.helpVisible?"1":"0",this.helpOverlay.style.pointerEvents=this.helpVisible?"auto":"none")}toggleScreenshotMode(){this.screenshotMode=!this.screenshotMode,this.screenshotMode&&this.helpVisible&&(this.helpVisible=!1,this.helpOverlay&&(this.helpOverlay.style.opacity="0",this.helpOverlay.style.pointerEvents="none")),this.debugOverlay&&(this.debugOverlay.style.display=this.screenshotMode?"none":"block"),this.shareNotification&&(this.shareNotification.textContent=this.screenshotMode?"📷 Screenshot mode (Space to exit)":"📷 UI restored",this.shareNotification.style.color="#60a5fa",this.shareNotification.style.opacity="1",setTimeout(()=>{this.shareNotification&&(this.shareNotification.style.opacity="0")},1e3))}createHelpContent(){return`
    ...
    `}destroy(){this.stop(),window.removeEventListener("resize",this.handleResize),window.removeEventListener("hashchange",this.handleHashChange),this.debugOverlay?.remove(),this.shareNotification?.remove(),this.helpOverlay?.remove(),this.inputHandler.destroy(),this.renderer.destroy()}}console.log("Fractal Explorer - Initializing...");let S=null;async function J(){const i=document.getElementById("app");if(!i){console.error("Could not find #app element");return}if(!P.isSupported()){i.innerHTML=`
    ...
    `}}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",()=>J()):J();window.addEventListener("beforeunload",()=>{S&&S.destroy()});
//# sourceMappingURL=index-CCGMnWx9.js.map
